...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Poverty rate (2007) & Unemployment rate (2014) & Ease of Doing Business Rank (2016) &  &  &  &  \\ 
   46.8 &   4.7 & 173.0 &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- &  --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 7.6 & 9.3 & 2.6 & 3.1 & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- &    --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 30.64 & 55.44 & 39.12 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  0.60 &  0.69 &  1.00 &  0.70 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &  7.67 &  2.44 &    NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- & --- &  --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 3.4 & 6.3 & 6.8 & 3.1 & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrr}
  ...
  \hline
Dealing with Construction Permits & 153 & 154 & \color{red}{\Large-1} &  \\ 
  Ease of Doing Business Rank & 167 & 173 & \color{red}{\Large-6} &  \\ 
  Enforcing Contracts & 189 & 189 & 0 &  \\ 
  Getting Credit & 160 & 162 & \color{red}{\Large-2} &  \\ 
  Getting Electricity & 89 & 95 & \color{red}{\Large-6} &  \\ 
  Paying Taxes & 55 & 57 & \color{red}{\Large-2} &  \\ 
  Protecting Minority Investors & 81 & 81 & 0 &  \\ 
  Registering Property & 189 & 189 & 0 &  \\ 
  Resolving Insolvency & 189 & 189 & 0 &  \\ 
  Starting a Business & 97 & 104 & \color{red}{\Large-7} &  \\ 
  Trading Across Borders & 91 & 92 & \color{red}{\Large-1} &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrl}
  ...
  \hline
Number of electrical outages in a typical month & 10.20 & 3.50 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 6.90 & 35.00 & 34.30 &  \\ 
  Proportion of investment financed by banks (\%) & 0.80 & 12.80 & 14.30 &  \\ 
  Proportion of investment financed internally (\%) & 98.60 & 74.70 & 71.80 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 3.70 & 6.70 & 9.90 &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:09:59 2016
\scalebox{0.85}{
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Timor-Leste - Country partnership strategy for the period FY2013-2017 & 2013-04-08 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}lll}
 Product & Concept Review Date & Board Date &  \\ 
  \hline
Timor-Leste PLR & 2016-01-20 & 2016-05-13 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600075 & Timor-Leste Trade Logistic & Silva, Jose Ricardo & 2014-06-12 & 2016-12-31 & 1,889 & 1,190 & 363 &  \\ 
  565307 & Timor-Leste Business Registration and Licensing Reform Project & Silva, Jose Ricardo & 2009-11-22 & 2016-06-30 & 2,757 & 1,960 &   0 &  \\ 
  600912 & Timor-Leste Investment Policy and Promotion & Silva, Jose Ricardo & --- & --- &     0 &     0 &   0 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600892 & TIMOR LESTE TIBAR BAY INVESTMENT PLAN (TBIP) - SPATIAL, SME, SKILLS AND GVC CLUSTER DEVELOPMENT & Tewari, Parth Shri & --- & 2017-12-31 & 1,075 & 233 & 217 &  \\ 
  \end{tabular}
}
}
