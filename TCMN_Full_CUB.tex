...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 10.5 &  8.6 &  8.9 & --- & --- & --- &  \\ 
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:17:14 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 10.6 & --- &  \\ 
  Binding (\%) & 31.5 & --- &  \\ 
  Dispersion (Standard Deviation) & 7.3 & --- &  \\ 
  Import duties collected \large{[1]} & --- & --- &  \\ 
  MFN Tariff (Agriculture) & 10.9 & --- &  \\ 
  MFN Tariff (Non-Agriculture) & 10.8 & --- &  \\ 
  MFN Tariff (Simple Average) & 10.7 & --- &  \\ 
  Services sectors with GATS commitments \large{[1]} & --- & 50 &  \\ 
  \end{tabular}
}
