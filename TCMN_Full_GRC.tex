...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/GR.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Greece}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   0.23 &  -3.98 &   0.80 &  -1.40 &  -1.20 &   0.50 &  \\ 
  Current account balance &  -8.42 &   1.98 &   3.27 &   6.66 &  10.30 &  12.26 &  \\ 
  Fiscal balance (\% of GDP) &  -8.10 &  -3.85 &  -0.99 &   0.23 &   1.23 &   2.18 &  \\ 
  Remittances, received (\% of GDP) \large{[1]} &   0.57 &   0.34 &   0.31 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 118.27 & 176.94 & 178.40 & 178.40 &     NA & --- &  \\ 
  Real Effective Exchange Rate (2010=100) & 103.48 &  99.47 &  97.29 &  91.33 &  88.70 &  86.41 &  \\ 
  Consumer Price Index, annual percent change &   3.16 &  -1.16 &  -1.48 &  -0.81 &  -2.22 &  -3.30 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & 20.14 & 11.40 & 11.75 &  7.72 &  0.99 & -5.18 &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 21.59 & 11.48 & 12.23 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  0.69 &  1.16 &  0.91 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &  3.33 & 10.38 &    NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Total Trade in Goods and Services (\% of GDP, real terms) & 53.44 & 58.34 & 62.58 & 62.60 & 62.60 & 63.00 &  \\ 
  Trade balance (\% GDP, real terms) & -9.72 & -2.54 & -2.37 &  1.04 &  4.83 &  6.98 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &  1.64 &  1.54 &  8.77 &  4.20 &  4.70 &  4.30 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) & -0.31 & -2.68 &  7.54 & -6.55 & -7.28 & -2.54 &  \\ 
  Total reserves in months of imports \large{[1]} &  0.64 &  0.78 &  0.83 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:12:00 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{68.3} & \textbf{68.38} & \textbf{\color{green}{0.08}} & \textbf{58} & \textbf{60} & \textbf{\color{red}{-2}} &  \\ 
  Dealing with Construction Permits & 72.63 & 72.63 & 0 & 60 & 60 & 0 &  \\ 
  Enforcing Contracts & 50.19 & 50.19 & 0 & 131 & 132 & \color{red}{-1} &  \\ 
  Getting Credit & 50 & 50 & 0 & 71 & 79 & \color{red}{-8} &  \\ 
  Getting Electricity & 80.57 & 80.57 & 0 & 44 & 47 & \color{red}{-3} &  \\ 
  Paying Taxes & 77.89 & 78.45 & \color{green}{0.56} & 63 & 66 & \color{red}{-3} &  \\ 
  Protecting Minority Investors & 61.67 & 61.67 & 0 & 44 & 47 & \color{red}{-3} &  \\ 
  Registering Property & 49.62 & 49.62 & 0 & 144 & 144 & 0 &  \\ 
  Resolving Insolvency & 55.98 & 56.28 & \color{green}{0.3} & 52 & 54 & \color{red}{-2} &  \\ 
  Starting a Business & 90.71 & 90.7 & \color{red}{-0.01} & 50 & 54 & \color{red}{-4} &  \\ 
  Trading Across Borders & 93.72 & 93.72 & 0 & 27 & 27 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:12:01 2016
{\Large
\begin{tabular}{lrr}
  & 2014 &  \\ 
  \hline
Import duties collected \large{[1]} & --- &  \\ 
  Services sectors with GATS commitments \large{[1]} & 115 &  \\ 
  \end{tabular}
}
...
\vspace*{+0.6cm}
  ...
  \begin{minipage}[c]{0.97\textwidth} 
    \begin{flushleft}  
      {\color{blue!50!black} \textbf{Enterprise Survey 2005}}
    \end{flushleft}  
    \vspace*{-0.4cm}
    \centering
    \resizebox{\textwidth}{!}{%
...
\begin{tabular}{lrrl}
  ...
  \hline
Number of electrical outages in a typical month & 6.30 & --- &  \\ 
  Percent of firms with a bank loan/line of credit & 35.20 & --- &  \\ 
  Proportion of investments financed by banks (\%) & 14.60 & 13.3 &  \\ 
  Proportion of investments financed internally (\%) & 71.20 & 71.3 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 10.00 & 1.8 &  \\ 
  \end{tabular}
}
    ...
    \\[8pt]
    %\hspace*{0.3cm} 
    \raggedright{\footnotesize{\href{https://www.enterprisesurveys.org/data}{Source: Enterprise Survey 2005}}}
  \end{minipage} 

  \begin{minipage}[b]{0.99\textwidth} 
    \vspace{+4ex}
    \begin{minipage}[c]{0.49\textwidth} % top 5 constraints ES
      \center{\color{blue!50!black} \textbf{Top 5 constraints according to ES 2005 \\ \footnotesize(\% respondants)}}
...
{\centering \includegraphics[width=\maxwidth]{figure/top5constraintsES-1} 
      ...
      %\vspace*{-0.7cm}
      \hspace*{0.3cm} \raggedright\footnotesize{\href{https://www.enterprisesurveys.org/data}{Source: Enterprise Survey 2005}}
    \end{minipage}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.4in}>{\raggedright}p{0.4in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Concept Approval Date & Output Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P144875 & Advisory Services Work Program & Thomas Edward Haven & 2013-03-28 & 2019-01-31 & PA & N & --- &   0 & --- & 2,099 &  \\ 
  P153114 & Investment licensing reform impl. & Thomas Edward Haven & 2014-10-30 & 2018-03-30 & TA & N &  0 & 326 &  0 &   326 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.4in}>{\raggedright}p{0.4in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Concept Approval Date & Output Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P151198 & Improving trade and transport logistics & Daria Taglioni & --- & 2015-12-21 & TA & N & --- & 0 & --- & 0 &  \\ 
  \end{tabular}
}
}
