...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/FM.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Micronesia, Fed. Sts.}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &   --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &  6.3 &  7.0 &  6.9 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 26.8 & 27.0 & 26.1 & 26.4 & 26.2 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 0.53 & 0.24 & 0.24 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 1.77 & 0.77 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- &  --- & --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 3.0 & 3.7 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:08:01 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{49.68} & \textbf{49.67} & \textbf{\color{red}{-0.01}} & \textbf{146} & \textbf{148} & \textbf{\color{red}{-2}} &  \\ 
  Dealing with Construction Permits & 61.02 & 61 & \color{red}{-0.02} & 140 & 141 & \color{red}{-1} &  \\ 
  Enforcing Contracts & 29.39 & 29.39 & 0 & 181 & 181 & 0 &  \\ 
  Getting Credit & 55 & 55 & 0 & 61 & 70 & \color{red}{-9} &  \\ 
  Getting Electricity & 64.42 & 64.4 & \color{red}{-0.02} & 98 & 103 & \color{red}{-5} &  \\ 
  Paying Taxes & 68.78 & 68.78 & 0 & 115 & 116 & \color{red}{-1} &  \\ 
  Protecting Minority Investors & 25 & 25 & 0 & 185 & 185 & 0 &  \\ 
  Registering Property & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Resolving Insolvency & 37.74 & 37.66 & \color{red}{-0.08} & 115 & 116 & \color{red}{-1} &  \\ 
  Starting a Business & 69.63 & 69.64 & \color{green}{0.01} & 151 & 162 & \color{red}{-11} &  \\ 
  Trading Across Borders & 85.85 & 85.85 & 0 & 52 & 53 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:08:02 2016
{\Large
\begin{tabular}{lrr}
  & 2006 &  \\ 
  \hline
Import duties collected (\%, 2011-2013) \large{[1]} & 1.7 &  \\ 
...
{\Large
\begin{tabular}{lrrrl}
  & Micronesia, Fed. Sts. & East Asia and Pacific & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 4.80 & 3.20 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 43.00 & 31.20 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 5.40 & 9.50 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 88.70 & 79.50 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 12.40 & 4.60 & 10.00 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Micronesia, Federated States of - Country partnership strategy for the period FY2014-2017 & 2014-06-05 &  \\ 
  \end{tabular}
}
