...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/TV.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Tuvalu}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 16 & 11 & 11 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 50 & 41 & 57 & 49 & 41 & --- &  \\ 
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:09:32 2016
{\Large
\begin{tabular}{lrr}
  & 2010 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 8.5 &  \\ 
  Dispersion (Standard Deviation) & 9.8 &  \\ 
  Import duties collected \large{[1]} & --- &  \\ 
  MFN Tariff (Agriculture) & 7.5 &  \\ 
  MFN Tariff (Non-Agriculture) & 7.7 &  \\ 
  MFN Tariff (Simple Average) & 7.7 &  \\ 
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Tuvalu - Country assistance strategy for the period FY2012-2015 & 2011-12-19 &  \\ 
  \end{tabular}
}
