...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  GDP (US\$ billions) (2017) & Population (millions) (2017) & Land area (sq. km) (2015) & Income per capita (current US\$) (2017) & Poverty rate (2012) \large{[1]} & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  \\ 
       21.1 &      16.1 & 176,520.0 &   1,314.7 &       6.2 &        NA &     127.0 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   7.91 &   7.41 &   7.09 &   6.86 &   6.85 &   6.82 &  \\ 
  Current account balance &  -5.29 & -10.30 &  -9.83 &  -7.99 &  -9.10 & -10.29 &  \\ 
  Fiscal balance (\% of GDP) &  -4.40 &  -5.78 &  -4.17 &  -4.87 &  -5.89 &  -5.87 &  \\ 
  Remittances, received (\% of GDP) \large{[1]} &   2.06 &   1.14 &   2.25 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  34.09 &  33.26 &  33.42 &  33.58 &  33.43 & --- &  \\ 
  Real Effective Exchange Rate (2010=100) &  97.52 & 105.55 & 103.23 & 101.71 &  94.83 &  95.92 &  \\ 
  Consumer Price Index, annual percent change &   5.39 &   3.02 &   3.80 &  -0.15 &  -0.18 &  -0.18 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & 20.0 & 15.9 & 24.3 & 23.7 & 23.1 & 22.1 &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 19.1 & 19.7 & 22.0 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7.6 & 12.3 & 10.5 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 42.3 & 69.4 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/createSparklines_invest-1} 
    ...
    \begin{minipage}[c]{0.875\textwidth}
      ...
      \resizebox{\textwidth}{!}{
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:58:45 2016
{\Large
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Total Trade in Goods and Services (\% of GDP, real terms) & 149.9 & 149.2 & 161.0 & 165.2 & 168.2 & 174.4 &  \\ 
  Trade balance (\% GDP, real terms) & -10.2 &  -1.7 &  -7.1 &  -6.2 &  -5.1 &  -3.6 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &  11.9 &  10.5 &  11.7 &  10.4 &   9.6 &  11.9 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) &  10.2 &  13.8 &  19.3 &   8.9 &   8.1 &   9.7 &  \\ 
  Total reserves in months of imports \large{[1]} &   4.6 &   5.0 &   5.4 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr|rrrr}
  ...
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{52.78} & \textbf{55.22} & \textbf{\color{green}{2.44}} & \textbf{133} & \textbf{127} & \textbf{\color{green}{6}} &  \\ 
  Dealing with Construction Permits & 37.49 & 38.12 & \color{green}{0.63} & 182 & 181 & \color{green}{1} &  \\ 
  Enforcing Contracts & 34.53 & 34.53 & 0 & 174 & 174 & 0 &  \\ 
  Getting Credit & 80 & 80 & 0 & 12 & 15 & \color{red}{-3} &  \\ 
  Getting Electricity & 45.63 & 52.37 & \color{green}{6.74} & 156 & 145 & \color{green}{11} &  \\ 
  Paying Taxes & 73.06 & 73.06 & 0 & 90 & 95 & \color{red}{-5} &  \\ 
  Protecting Minority Investors & 48.33 & 48.33 & 0 & 109 & 111 & \color{red}{-2} &  \\ 
  Registering Property & 54.87 & 54.92 & \color{green}{0.05} & 119 & 121 & \color{red}{-2} &  \\ 
  Resolving Insolvency & 45.02 & 45.11 & \color{green}{0.09} & 80 & 82 & \color{red}{-2} &  \\ 
  Starting a Business & 41.23 & 58.1 & \color{green}{16.87} & 185 & 180 & \color{green}{5} &  \\ 
  Trading Across Borders & 67.63 & 67.63 & 0 & 97 & 98 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:58:46 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 13.2 & 8.0 &  \\ 
  Binding (\%) & 100 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 10.1 & 9.2 &  \\ 
  Import duties collected (\%, 2012-2014) \large{[1]} & --- & 3.0 &  \\ 
  MFN Tariff (Agriculture) & 15.3 & 15.4 &  \\ 
  MFN Tariff (Non-Agriculture) & 11.3 & 10.0 &  \\ 
  MFN Tariff (Simple Average) & 12 & 10.8 &  \\ 
  Services sectors with GATS commitments \large{[1]} & --- & 94.0 &  \\ 
  \end{tabular}
}
...
\vspace*{+0.6cm}
  ...
  \begin{minipage}[c]{0.97\textwidth} 
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:58:47 2016
{\Large
\begin{tabular}{lrrrl}
  & East Asia and Pacific & Cambodia & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 3.20 & 6.00 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 31.20 & 36.80 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 9.50 & 3.90 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 79.50 & 91.30 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 4.60 & 1.30 & 10.00 &  \\ 
  \end{tabular}
}
