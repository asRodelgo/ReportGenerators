...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   7.97 &   7.31 &   7.41 &   7.09 &   6.86 &   6.85 &  \\ 
  Current account balance &  -4.92 &  -9.79 & -10.30 &  -9.83 &  -7.99 &  -9.10 &  \\ 
  Fiscal balance (\% of GDP) &  -4.30 &  -5.58 &  -5.78 &  -4.17 &  -4.87 &  -5.89 &  \\ 
  Remittances, received (\% of GDP) \large{[1]} &   2.15 &   1.23 &   1.14 &   2.25 & --- & --- &  \\ 
  Real Effective Exchange Rate (2010=100) &  97.09 & 102.63 & 105.55 & 103.23 & 101.71 &  94.83 &  \\ 
  Consumer Price Index, annual percent change &   5.61 &   2.93 &   3.02 &   3.80 &  -0.15 &  -0.18 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2002-2011 & 2012 & 2013 & 2014 & 2015 & 2016 &  \\ 
  \hline
Gross domestic investment (\% GDP) & 20 & 15 & 16 & 24 & 24 & 23 &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 19 & 19 & 20 & 22 & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7 & 13 & 12 & 11 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 31 & 59 & NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2002-2011 & 2012 & 2013 & 2014 & 2015 & 2016 &  \\ 
  \hline
Total Trade in Goods and Services (\% of GDP, real terms) & 150.49 & 142.87 & 149.20 & 161.02 & 165.18 & 168.17 &  \\ 
  Trade balance (\% GDP, real terms) & -11.09 &   0.46 &  -1.71 &  -7.12 &  -6.18 &  -5.11 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &  14.53 & -16.76 &  10.52 &  11.74 &  10.41 &   9.58 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) &  13.50 & -26.67 &  13.82 &  19.32 &   8.90 &   8.05 &  \\ 
  Total reserves in months of imports \large{[1]} &   4.78 &   5.72 &   4.97 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:04:41 2016
{\large
\begin{tabular}{lrrrr}
  & DB 2015 Rank & DB 2016 Rank & Change in Rank &  \\ 
  \hline
Dealing with Construction Permits & 182 & 181 & \color{green}{\Large1} &  \\ 
  Ease of Doing Business Rank & 133 & 127 & \color{green}{\Large6} &  \\ 
  Enforcing Contracts & 174 & 174 & 0 &  \\ 
  Getting Credit & 12 & 15 & \color{red}{\Large-3} &  \\ 
  Getting Electricity & 156 & 145 & \color{green}{\Large11} &  \\ 
  Paying Taxes & 90 & 95 & \color{red}{\Large-5} &  \\ 
  Protecting Minority Investors & 109 & 111 & \color{red}{\Large-2} &  \\ 
  Registering Property & 119 & 121 & \color{red}{\Large-2} &  \\ 
  Resolving Insolvency & 80 & 82 & \color{red}{\Large-2} &  \\ 
  Starting a Business & 185 & 180 & \color{green}{\Large5} &  \\ 
  Trading Across Borders & 97 & 98 & \color{red}{\Large-1} &  \\ 
  \end{tabular}
}
...
\vspace*{+0.6cm}
  ...
  \begin{minipage}[c]{0.97\textwidth} 
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:04:43 2016
{\Large
\begin{tabular}{lrrrl}
  & East Asia and Pacific & Cambodia & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 3.50 & 6.00 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 35.00 & 36.80 & 34.30 &  \\ 
  Proportion of investment financed by banks (\%) & 12.80 & 3.90 & 14.30 &  \\ 
  Proportion of investment financed internally (\%) & 74.70 & 91.30 & 71.80 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 6.70 & 1.30 & 9.90 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}lll}
 Product & Concept Review Date & Board Date &  \\ 
  \hline
Cambodia Country Engagement Note (CEN) & 2015-11-04 & 2016-05-17 &  \\ 
  \end{tabular}
}
...
P147231 & TDSP Additional Financing & Julian Latimer Clarke & 2014-01-31 & IPF & --- &  3 & 0 & --- & --- & --- & 0 &  \\ 
  P109648 & KH - Trade Development Support Program & Julian Latimer Clarke & 2009-01-07 & IPF & 2016-08-14 & 12 & 3 & S & S & L & 0 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Management Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P149324 & Trade Related Assistance Cambodia - TRAC & Julian Latimer Clarke & 2016-12-14 & PA & N & --- & 159 & --- & 170 &  \\ 
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Management Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P115576 & KH-Technical Assistance to TRAC & Julian Latimer Clarke & 2015-06-03 & TA & N & --- & 0 & --- & 3,020 &  \\ 
  P126672 & KH-Investment Climate Assessment (ICA) 3 & Julian Latimer Clarke & 2014-12-31 & EW & N & --- & 0 & --- &   371 &  \\ 
  P129014 & KH-ASEAN work & Julian Latimer Clarke & 2013-07-29 & TA & N & --- & 0 &  0 &   395 &  \\ 
  P125722 & KH-Trade in Services & Julian Latimer Clarke & 2013-05-16 & EW & N & --- & 0 & 15 &   114 &  \\ 
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600402 & Cambodia Investment Policy & Schneider, Charles Patrick & --- & 2017-03-31 & 1,228 & 403 & 169 &  \\ 
  600416 & Cambodia IC Agribusiness & Nguyen, Lan Van & --- & 2019-12-31 & 2,870 &   2 &   0 &  \\ 
  \end{tabular}
}
}
