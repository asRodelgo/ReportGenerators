...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Gross capital formation (\% of GDP) \large{[1]} & 32.0 & 47.2 & --- & --- & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &  7.7 &  8.9 &  7.3 &  6.5 & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} & 21.4 & 18.2 & --- & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  7.2 & 18.1 & 21.1 & 16.8 & 18.7 & 16.6 &  \\ 
  \end{tabular}
}
