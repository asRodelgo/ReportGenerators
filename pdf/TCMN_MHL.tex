...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Foreign direct investment, net inflows (\% of GDP) \large{[2]} & 14 & 15 & 12 & 15 & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} & 24 & 24 & --- & --- & --- & --- &  \\ 
  Personal remittances, received (\% of GDP) \large{[1]} & 16 & 13 & 13 & 14 & --- & --- &  \\ 
  General government gross debt \large{[3]} & 43 & 30 & 32 & 30 & 29 & 26 &  \\ 
  \end{tabular}
}
