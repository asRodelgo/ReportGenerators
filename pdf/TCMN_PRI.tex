...
% Tue Jan 12 13:50:55 2016
{\LARGE
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2015) & Unemployment rate (2014) & Ease of Doing Business Rank (2015) &  \\ 
   3.5 & 14.3 & 56.0 &  \\ 
  \end{tabular}
}
...
% Tue Jan 12 13:50:55 2016
{\Large
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2002-2011 & 2012 & 2013 &  \\ 
  \hline
Gross capital formation (\% of GDP) \large{[1]} & 13.0 & 10.4 &  9.7 &  \\ 
  \end{tabular}
}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in 1:ncol(x): argument of length 0}}\end{kframe}
      \vspace*{-0.4cm}
      \end{minipage}
