...
% Tue Jan 12 13:52:53 2016
{\LARGE
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (2015) & Poverty rate (2007) & Unemployment rate (2015) & Ease of Doing Business Rank (2015) &  \\ 
    1.3 &  46.8 &    NA & 167.0 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Gross capital formation (\% of GDP) \large{[1]} & 30.91 & 55.44 & 39.12 & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &  0.60 &  0.69 &  1.00 &  0.70 &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  7.67 &  2.44 & --- & --- &  \\ 
  Personal remittances, received (\% of GDP) \large{[1]} &  7.63 &  9.26 &  2.55 &  3.08 &  \\ 
  Total reserves in months of imports \large{[1]} &  3.45 &  6.31 &  6.76 &  3.06 &  \\ 
  \end{tabular}
}
