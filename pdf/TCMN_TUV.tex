...
% Tue Jan 12 13:53:20 2016
{\LARGE
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2015) & Unemployment rate (2015) &  \\ 
  0.01 &   NA &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Personal remittances, received (\% of GDP) \large{[1]} & 17.3 &  9.6 & 10.6 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 50.7 & 43.0 & 41.1 & 56.9 & 48.0 & 40.2 &  \\ 
  \end{tabular}
}
...
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 8.5 &  \\ 
  ...
  MFN Tariff (Agricul.) & 7.5 &  \\ 
  MFN Tariff (Non-Agricul.) & 7.7 &  \\ 
