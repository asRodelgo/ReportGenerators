...
\begin{minipage}[b]{0.99\textwidth} % macro indicators main table
  \begin{minipage}[t]{0.99\textwidth}
    \begin{minipage}[c]{0.49\textwidth}
      ...
      \end{flushleft} 
      \vspace*{-0.4cm}
      \center{\color{blue!50!black} \textbf{\small Projects portfolio status \\ by number of projects}}
...
{\centering \includegraphics[width=\maxwidth]{figure/projectStatus_count-1} 
      ...
      \end{minipage}
      \begin{minipage}[c]{0.49\textwidth}
      \center{\color{blue!50!black} \textbf{\small Projects portfolio status \\ by amount in thousands of US\$}}
...
%'       <<ExpImp_HF,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3.3,fig.width=8,results="asis">>=  
%'       @
%'     \vspace*{-0.3cm}
%'     %\hspace*{0.5cm} 
...
%'         <<GVA_Treemap,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3,fig.width=8,results="asis">>=  
%'         @
%'    %\vspace*{-0.3cm}
%'    %\hspace*{0.5cm} 
...
%'     %\vspace*{-0.2cm}
%'     \begin{minipage}[t]{0.99\textwidth} 
%'       {\color{blue!50!black} \textbf{\small Top 5 Exports by \% of Total Value, expYear}}
%'       %\vspace{3ex}
%'       \\[6pt]
%'       \centering
%'       \resizebox{\textwidth}{!}{%
%'     <<ImpExp_Treemap-2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2.5,fig.width=8,results="asis">>=  
%'       @            
%'       }
%'       \end{minipage}
%'       \\[14pt]
%'       \begin{minipage}[t]{0.99\textwidth} 
%'       {\color{blue!50!black} \textbf{\small Imports Categories by \% of Total Value, impYear}}
%'       \\[6pt]
%'       \centering
%'       \resizebox{\textwidth}{!}{%
%'     <<ImpExp_Treemap-1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=1.6,fig.width=8,results="asis">>=  
%'       @            
%'       }
%'       \end{minipage}
%'       \\[10pt]
...
%'     \vspace*{-0.6cm}
%'       <<WEFradar,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5.4,fig.width=7,results="asis">>=  
%'     @      
%'     \vspace*{-1.2cm} 
