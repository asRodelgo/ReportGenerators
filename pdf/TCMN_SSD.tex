...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Gross capital formation (\% of GDP) \large{[1]} & 11.50 & 11.18 & 10.60 & 10.36 & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} & --- &  0.00 & -0.66 & -7.29 & --- & --- &  \\ 
  General government gross debt \large{[3]} &  0.00 &  4.50 & 12.36 & 20.27 & 49.43 & 51.68 &  \\ 
  \end{tabular}
}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `\$<-.data.frame`(`*tmp*`, "{}IndicatorShort"{}, value = NA\_character\_): replacement has 1 row, data has 0}}\end{kframe}
    }
    \\[20pt]
    %\hspace*{0.5cm} 
