...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Foreign direct investment, net inflows (\% of GDP) \large{[2]} & 0.66 & 2.50 & 1.58 & 1.97 &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} & 2.78 & 9.81 & --- & --- &  \\ 
  \end{tabular}
}
...
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 6.7 & 5.7 &  \\ 
  ...
  MFN Tariff (Agricul.) & 6.7 & 5.7 &  \\ 
  MFN Tariff (Non-Agricul.) & 11.4 & 9.7 &  \\ 
