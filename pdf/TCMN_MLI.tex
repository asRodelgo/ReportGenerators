...
GDP growth (annual \%) &   5.71 &  -0.40 &   2.10 &   7.22 &   4.96 &   5.02 &  \\ 
  ...
  Cash surplus/deficit (\% of GDP) &  -0.25 &  -1.15 &  -3.25 &  -3.52 &  -3.14 &  -4.46 &  \\ 
  Gross Fixed Investment (\% GDP) &  22.02 &  16.68 &  20.10 &  29.17 &  44.31 &  46.12 &  \\ 
  Gross capital formation (\% of GDP) \large{[1]} &  21.74 &  21.67 &  20.56 &  24.14 & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &   3.92 &   3.85 &   2.81 &   1.71 & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  20.38 &  23.94 & --- & --- & --- & --- &  \\ 
  ...
  Personal remittances, received (\% of GDP) \large{[1]} &   4.50 &   8.00 &   8.17 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  34.10 &  29.75 &  30.64 &  36.74 &  42.55 &  41.73 &  \\ 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in seq.default(from = best\$lmin, to = best\$lmax, by = best\$lstep): 'from' must be of length 1}}\end{kframe}
    \vspace*{-0.3cm}
    %\hspace*{0.5cm} 
