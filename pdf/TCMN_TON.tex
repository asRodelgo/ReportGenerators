...
% Tue Jan 12 13:53:00 2016
{\LARGE
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2015) & Poverty rate (2009) & Unemployment rate (2015) & Ease of Doing Business Rank (2015) &  \\ 
   0.11 &  1.09 &    NA & 74.00 &  \\ 
  \end{tabular}
}
...
% Tue Jan 12 13:53:00 2016
{\Large
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2002-2011 & 2012 & 2013 & 2014 &  \\ 
  \hline
Gross capital formation (\% of GDP) \large{[1]} & 24.6 & 34.0 & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &  7.6 &  6.7 & 11.7 & 12.9 &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} & 12.9 &  5.3 & --- & --- &  \\ 
  Personal remittances, received (\% of GDP) \large{[1]} & 27.1 & 25.7 & 27.9 & --- &  \\ 
...
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 11.1 & --- &  \\ 
  ...
  MFN Tariff (Agricul.) & 11.7 & --- &  \\ 
  MFN Tariff (Non-Agricul.) & 11.5 & --- &  \\ 
