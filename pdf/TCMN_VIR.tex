...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Foreign direct investment, net inflows (\% of GDP) \large{[2]} &  2,837 &  7,475 & 10,081 &  6,175 &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} & 11,863 & 33,249 & --- & --- &  \\ 
  \end{tabular}
}
