...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
Foreign direct investment, net inflows (\% of GDP) \large{[2]} &  0.55 &  0.31 &  0.24 &  0.24 & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  1.83 &  0.78 & --- & --- & --- & --- &  \\ 
  Personal remittances, received (\% of GDP) \large{[1]} &  6.22 &  6.38 &  6.98 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 26.79 & 27.71 & 27.08 & 26.94 & 27.25 & 27.23 &  \\ 
  Total reserves in months of imports \large{[1]} &  2.92 &  3.31 &  3.74 & --- & --- & --- &  \\ 
  \end{tabular}
}
