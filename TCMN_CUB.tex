...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/CU.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Cuba}
    \end{minipage}
  \end{minipage}
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 10.3 &  8.9 & --- & --- & --- & --- &  \\ 
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:35:24 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 10.6 & 9.8 &  \\ 
  Binding (\%) & 31.5 & 31.4 &  \\ 
  Dispersion (Standard Deviation) & 7.3 & 6.5 &  \\ 
  MFN Tariff (Agriculture) & 10.9 & 10.6 &  \\ 
  MFN Tariff (Non-Agriculture) & 10.8 & 10.4 &  \\ 
  MFN Tariff (Simple Average) & 10.7 & 10.3 &  \\ 
  \end{tabular}
}
