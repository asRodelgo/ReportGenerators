...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/PW.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Palau}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &   --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 0.87 & 1.03 & 0.89 & --- & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 2.03 & 0.74 & 2.22 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 6.28 & 2.97 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:08:30 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{53.43} & \textbf{53.43} & \textbf{0} & \textbf{131} & \textbf{136} & \textbf{\color{red}{-5}} &  \\ 
  Dealing with Construction Permits & 67.56 & 67.56 & 0 & 96 & 101 & \color{red}{-5} &  \\ 
  Enforcing Contracts & 50.36 & 50.36 & 0 & 129 & 130 & \color{red}{-1} &  \\ 
  Getting Credit & 50 & 50 & 0 & 71 & 79 & \color{red}{-8} &  \\ 
  Getting Electricity & 54.78 & 54.81 & \color{green}{0.03} & 137 & 138 & \color{red}{-1} &  \\ 
  Paying Taxes & 64.65 & 64.65 & 0 & 129 & 131 & \color{red}{-2} &  \\ 
  Protecting Minority Investors & 28.33 & 28.33 & 0 & 182 & 182 & 0 &  \\ 
  Registering Property & 74.27 & 74.28 & \color{green}{0.01} & 46 & 46 & 0 &  \\ 
  Resolving Insolvency & 16.28 & 16.28 & 0 & 166 & 166 & 0 &  \\ 
  Starting a Business & 81.83 & 81.85 & \color{green}{0.02} & 109 & 116 & \color{red}{-7} &  \\ 
  Trading Across Borders & 46.22 & 46.22 & 0 & 155 & 155 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:08:31 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 5.0 & 3.3 &  \\ 
  Dispersion (Standard Deviation) & 34.1 & 7.9 &  \\ 
  MFN Tariff (Agriculture) & 12.1 & 3.5 &  \\ 
  MFN Tariff (Non-Agriculture) & 3.3 & 3.0 &  \\ 
  MFN Tariff (Simple Average) & 4.4 & 3.1 &  \\ 
  \end{tabular}
}
