...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Unemployment rate (2016) &  &  &  &  &  \\ 
        5.5 & 469,930.0 &        NA &  &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &   --- & --- &  \\ 
  ...
  General government gross debt \large{[3]} &  8.2 & 20.8 & 17.4 & 23.3 & 24.0 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 34.0 & --- & --- & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7.8 &  7.3 &  6.5 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 21.1 & 14.5 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
