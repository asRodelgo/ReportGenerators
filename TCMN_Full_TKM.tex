...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2016) & Unemployment rate (2014) &  &  &  &  &  \\ 
   5.4 & 10.5 &  &  &  &  &  \\ 
  \end{tabular}
}
...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 32.5 & 47.2 & --- & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7.7 &  8.9 &  7.3 &  6.5 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 21.4 & 18.2 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}lll}
 Product & Concept Review Date & Board Date &  \\ 
  \hline
Turkmenistan Country Engagement Note & 2015-04-29 & 2015-11-03 &  \\ 
  \end{tabular}
}
...
P152429 & Conference on Competitiveness & Emanuel Salinas Munoz & 2014-12-24 & TA & N & --- & 0 & 118 & 118 &  \\ 
  P147637 & TM FSD/PSD Dialogue & Emanuel Salinas Munoz & 2014-12-17 & PA & N & --- & 0 & 116 & 116 &  \\ 
  P148087 & TKM WTO Accession & Gohar Gyulumyan & 2014-12-02 & TA & N & --- & 0 &  36 &  36 &  \\ 
  ...
  P132598 & TM - Financial and Private Sector Dev & Emanuel Salinas Munoz & 2013-06-26 & TA & N & --- & 0 & 119 & 119 &  \\ 
  \end{tabular}
}
}
