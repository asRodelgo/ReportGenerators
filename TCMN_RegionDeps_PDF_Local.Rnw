...
\raggedright{\color{white!30!blue} \textbf{\Large Region: \Sexpr{countryDeps[countryDeps$CMU==couDep,]$Region[1]}}}

\raggedright{\color{white!30!blue} \textbf{\Large Country Management Unit: \Sexpr{couDep}}}
