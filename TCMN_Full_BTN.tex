...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/BT.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Bhutan}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Poverty rate (2012) \large{[1]} & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  \\ 
       0.79 & 38,117.00 &      2.20 &      3.20 &     71.00 &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &     --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &   0.46 &   0.66 &   0.73 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  71.23 &  89.18 & 107.40 & 115.65 & 122.01 & --- &  \\ 
...
{\centering \includegraphics[width=\maxwidth]{figure/createSparklines_macro-1} 
    ...
    \begin{minipage}[c]{0.875\textwidth}
      ...
      \resizebox{\textwidth}{!}{
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:26 2016
{\Large
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & --- & --- &    --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 53.56 & 45.96 & 57.75 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  2.25 &  0.49 &  0.30 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &  4.37 &  1.04 &    --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 11.2 &  9.3 & 11.9 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{minipage}[b]{0.99\textwidth}
  \vspace{0.8cm}
   \begin{minipage}[c]{0.44\textwidth} 
    %\vspace*{-0.2cm}
    \begin{minipage}[t]{0.99\textwidth} 
      {\color{blue!50!black} \textbf{\small Top 5 Exports by \% of Total Value, 2012}}
      %\vspace{3ex}
      \\[6pt]
      \centering
      \resizebox{\textwidth}{!}{%
...
\begin{tabular}{lrrr|rrrr}
  ...
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{64.9} & \textbf{65.21} & \textbf{\color{green}{0.31}} & \textbf{70} & \textbf{71} & \textbf{\color{red}{-1}} &  \\ 
  Dealing with Construction Permits & 69.97 & 70.07 & \color{green}{0.1} & 74 & 79 & \color{red}{-5} &  \\ 
  Enforcing Contracts & 65.36 & 65.36 & 0 & 50 & 50 & 0 &  \\ 
  Getting Credit & 50 & 50 & 0 & 71 & 79 & \color{red}{-8} &  \\ 
  Getting Electricity & 78.9 & 80.09 & \color{green}{1.19} & 52 & 50 & \color{green}{2} &  \\ 
  Paying Taxes & 85.5 & 85.5 & 0 & 26 & 28 & \color{red}{-2} &  \\ 
  Protecting Minority Investors & 46.67 & 46.67 & 0 & 114 & 115 & \color{red}{-1} &  \\ 
  Registering Property & 71.61 & 73.4 & \color{green}{1.79} & 56 & 51 & \color{green}{5} &  \\ 
  Resolving Insolvency & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Starting a Business & 85.54 & 85.57 & \color{green}{0.03} & 85 & 91 & \color{red}{-6} &  \\ 
  Trading Across Borders & 95.49 & 95.49 & 0 & 21 & 21 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:28 2016
{\Large
\begin{tabular}{lrrr}
  & 2007 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & --- & 12.1 &  \\ 
  Dispersion (Standard Deviation) & --- & 14.4 &  \\ 
  Import duties collected (\%, 2012-2014) \large{[1]} & 0.5 & --- &  \\ 
  MFN Tariff (Agriculture) & --- & 41.2 &  \\ 
  MFN Tariff (Non-Agriculture) & --- & 18.5 &  \\ 
  MFN Tariff (Simple Average) & --- & 21.6 &  \\ 
...
{\Large
\begin{tabular}{lrrrl}
  & South Asia & Bhutan & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 25.40 & 0.40 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 27.00 & 46.50 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 14.40 & 18.90 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 73.90 & 75.10 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 7.20 & 28.80 & 10.00 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Bhutan - Country partnership strategy for the period FY2015-19 & 2014-09-29 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.4in}>{\raggedright}p{0.4in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Concept Approval Date & Output Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P153221 & Improving Bhutan Investment Climate & Massimiliano Santini & 2015-04-06 & 2017-06-30 & PA & N & 125 & 125 & 346 & 346 &  \\ 
  P160388 & Property Registration & Massimiliano Santini & --- & 2016-02-29 & TA & N &  --- &   0 &  --- &   0 &  \\ 
  \end{tabular}
}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:29 2016
{\scriptsize
\scalebox{0.85}{
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.4in}>{\raggedright}p{0.4in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Concept Approval Date & Output Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P147082 & Bhutan Doing Business Reform TA & Mihasonirina Andrianaivo & 2013-09-09 & 2014-06-10 & TA & N & --- & 0 & 88 & 88 &  \\ 
  P077143 & BT-Hydropower Exports \& Exch. Rate Study & Naoko C. Kojo & --- & 2002-10-04 & EW & N & --- & 0 & 78 & 78 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
577347 & Bhutan Licensing Reform & Azhar, Shihab Ansari & 2010-11-03 & 2014-06-30 & 547 & 544 & 0 &  \\ 
  537785 & FDI Rules and Regulations  & Crittle, Frederick J. & 2005-08-11 & --- &   0 &   0 & 0 &  \\ 
  538807 & Institutional Arrangements for FDI Activities & Crittle, Frederick J. & 2005-08-10 & --- &   0 &   0 & 0 &  \\ 
  537505 & Improving Registration and Regulatory Processes in Bhutan & Qayyum, Sayef Tanzeem & 2005-07-10 & 2010-06-30 & 682 & 431 & 0 &  \\ 
  537984 & Export Business Intensification Program for Bhutan SME Sector & Haider, Narissa & 2005-07-10 & 2008-02-28 & 387 & 311 & 0 &  \\ 
  538083 & Bhutan Feasibility Studies on Industrial Estates, IT Park and Distance Learning Center & Faisal, Islam Mohammad & 2005-07-10 & --- &   0 &   0 & 0 &  \\ 
  \end{tabular}
}
}
