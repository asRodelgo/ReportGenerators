...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/KN.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}St. Kitts and Nevis}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &    --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &   6.0 &   6.5 &   6.0 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 143.5 & 100.4 &  80.2 &  65.5 &  59.6 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 39 & 31 & 30 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} & 18 & 19 & 15 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 45 & 64 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- &  --- & --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 4.2 & 9.1 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:09:01 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{55.81} & \textbf{55.83} & \textbf{\color{green}{0.02}} & \textbf{122} & \textbf{124} & \textbf{\color{red}{-2}} &  \\ 
  Dealing with Construction Permits & 77.27 & 77.31 & \color{green}{0.04} & 31 & 32 & \color{red}{-1} &  \\ 
  Enforcing Contracts & 66.87 & 66.87 & 0 & 42 & 42 & 0 &  \\ 
  Getting Credit & 25 & 25 & 0 & 150 & 152 & \color{red}{-2} &  \\ 
  Getting Electricity & 69.93 & 70.02 & \color{green}{0.09} & 80 & 84 & \color{red}{-4} &  \\ 
  Paying Taxes & 60.64 & 60.64 & 0 & 143 & 147 & \color{red}{-4} &  \\ 
  Protecting Minority Investors & 53.33 & 53.33 & 0 & 87 & 88 & \color{red}{-1} &  \\ 
  Registering Property & 40.3 & 40.31 & \color{green}{0.01} & 167 & 170 & \color{red}{-3} &  \\ 
  Resolving Insolvency & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Starting a Business & 85.56 & 85.66 & \color{green}{0.1} & 84 & 90 & \color{red}{-6} &  \\ 
  Trading Across Borders & 79.2 & 79.2 & 0 & 69 & 70 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:09:02 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 12.2 & 11.6 &  \\ 
  Binding (\%) & 97.5 & 97.5 &  \\ 
  Dispersion (Standard Deviation) & 11.3 & 11.0 &  \\ 
  MFN Tariff (Agriculture) & 14.4 & 13.5 &  \\ 
  MFN Tariff (Non-Agriculture) & 8.3 & 8.3 &  \\ 
  MFN Tariff (Simple Average) & 9.2 & 9.1 &  \\ 
  \end{tabular}
}
...
{\Large
\begin{tabular}{lrrrl}
  & St. Kitts and Nevis & Latin America and Caribbean & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 4.20 & 2.80 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 49.30 & 45.20 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 32.30 & 19.30 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 47.90 & 63.20 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 10.60 & 14.00 & 10.00 &  \\ 
  \end{tabular}
}
