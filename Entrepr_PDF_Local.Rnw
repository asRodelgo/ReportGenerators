...
\begin{minipage}[c]{0.875\textwidth}
  \begin{flushleft}  
    {\color{white!10!blue} \textbf{\LARGE Policy}}
  \end{flushleft}
  \vspace*{-0.4cm}
  % Table 2
  \centering
  \resizebox{\textwidth}{!}{
  <<table_time_avg_Policy,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',results="asis">>=  
  @      
  }
\end{minipage}
...
\begin{minipage}[b]{0.99\textwidth}
  ...
  \begin{minipage}[c]{0.44\textwidth} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
    <<line_chart_Policy,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=10,results="asis">>=  
      @            
      }
    \\[10pt]
  %\hspace*{0.5cm}
...
\begin{minipage}[b]{0.875\textwidth}
   \vspace{2ex}
   \begin{flushleft}  
     {\color{white!10!blue} \textbf{\LARGE Human capital}}
   \end{flushleft} 
\vspace{0.5cm}
  \begin{minipage}[c]{0.48\textwidth} % WEF Radar
    ...
    \vspace*{-0.6cm}
      <<bar_facewrap_chart_Human,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5.5,fig.width=7.5,results="asis">>=  
    @      
    \vspace*{-0.6cm} 
...
\begin{minipage}[b]{0.875\textwidth}
  \vspace{2ex}
  \begin{flushleft}  
   {\color{white!10!blue} \textbf{\LARGE Finance}}
  \end{flushleft} 
  \vspace{0.5cm}
  \begin{minipage}[c]{0.75\textwidth} % WEF Radar
...
%'   \begin{minipage}[c]{0.11\textwidth}
%'       \vspace*{+1cm}
%'       <<sparklines_Finance,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4.5,fig.width=4,results="asis">>=  
%'       @
%'       \vspace*{-0.5cm}
%'   \end{minipage}
  %\end{minipage}
  \begin{minipage}[c]{0.24\textwidth} % 
    \center{\color{blue!50!black} \textbf{Population employed in services sector \\ \footnotesize(\% total employed population)}}
    \vspace*{-0.6cm}
      <<line_chart_Finance,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=8,fig.width=11,results="asis">>=  
    @      
    \vspace*{-0.6cm} 
    \hspace*{0.3cm} \raggedright\footnotesize{\href{http://www.weforum.org/global-competitiveness-report-2015-2016}{Source: WEF Global Competitiveness Report 2015}}
  \end{minipage}
...
\begin{minipage}[b]{0.875\textwidth}
  \vspace{2ex}
  \begin{flushleft}  
    {\color{white!10!blue} \textbf{\LARGE Markets}}
  \end{flushleft}
  \vspace{0.5cm}
  \begin{minipage}[c]{0.48\textwidth} % WEF Radar
    \center{\color{blue!50!black} \textbf{Financial inclusion \\ \footnotesize(\% age 15+)}}
    \vspace*{-0.6cm}
      <<radar_chart_Markets,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5.5,fig.width=7.5,results="asis">>=  
    @      
    \vspace*{-0.6cm} 
    \hspace*{0.3cm} \raggedright\footnotesize{\href{http://www.weforum.org/global-competitiveness-report-2015-2016}{Source: WEF Global Competitiveness Report 2015}}
  \end{minipage}
  ...
  \centering
    \resizebox{\textwidth}{!}{
    <<table_region_Markets,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4.5,fig.width=9,results="asis">>=  
    @            
    }
\vspace{+1ex}    
    <<tcombo_percent_Markets1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3,fig.width=8,results="asis">>=  
    @            
\vspace{+1ex}
    <<combo_percent_Markets2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3,fig.width=8,results="asis">>=  
    @            
...
\begin{minipage}[c]{0.875\textwidth}
  \begin{flushleft}  
    {\color{white!10!blue} \textbf{\LARGE Culture}}
  \end{flushleft}
  \vspace*{-0.4cm}
  % Table 2
  \centering
...
\begin{minipage}[c]{0.11\textwidth}
  \vspace*{+1cm}
  <<sparklines_Culture,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=4.5,fig.width=4,results="asis">>=  
  @
  \vspace*{-0.5cm}
\end{minipage}
...
\begin{minipage}[c]{0.875\textwidth}
  \begin{flushleft}  
    {\color{white!10!blue} \textbf{\LARGE Supports}}
  \end{flushleft}
  \vspace*{-0.4cm}
  % Table 2
  \centering
