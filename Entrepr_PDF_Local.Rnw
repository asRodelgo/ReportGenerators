...
\begin{minipage}[b]{0.80\textwidth} % overview section
      \begin{minipage}[t]{0.30\textwidth}
    <<figure_sparkline1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.height=8,fig.width=11,fig.align='center',results="asis">>=  
      @      
      \end{minipage}
      \begin{minipage}[t]{0.30\textwidth}
