...
%       @      
        <<bar_chart_Markets,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5.5,fig.width=9,results="asis">>=  
      @      
      \vspace*{-0.1cm} 
    ...
    \begin{minipage}[c]{0.49\textwidth} % 
      ...
      %\begin{minipage}[c]{0.99\textwidth} % 
        <<number_chart_Markets,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=6,fig.width=11,results="asis">>=  
        @            
      \vspace{2ex}
      %\end{minipage}
...
%% Culture --------------------------------------------
 ...
 % {\color{blue!50!white}\noindent\makebox[\linewidth]{\rule{18cm}{0.3pt}}} % horiz line
  ...
  \begin{minipage}[c]{0.125\textwidth}
    \vspace*{+1cm}
    <<sparklines_Supports,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=5.7,fig.width=4.8,results="asis">>=  
    @
    \vspace*{-0.5cm}
  \end{minipage}
...
\end{minipage}
  ...
  \begin{minipage}[c]{0.65\textwidth}
    \vspace*{-0.1cm}
    \raggedleft{\color{white!40!black} \footnotesize DIGITAL ENTREPRENEURSHIP AT A GLANCE - LAST UPDATE \Sexpr{date}}
  \end{minipage}
\end{figure}
%%%%%%%%%%%%%%%% END OF DOCUMENT %%%%%%%%%%%%%%%%%%%
\end{document}