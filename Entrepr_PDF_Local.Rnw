...
%% Finance --------------------------------------------
\begin{figure}
  \vspace{105ex} % move down this figure
  %\hspace{-7ex} % move left this figure
  \includegraphics[width=21.7cm,height=11.5cm]{/Users/asanchez3/Desktop/Work/TCMN/ReportGenerators/www/bottom_background_grey.png}
\end{figure}
  ...
  \begin{minipage}[c]{0.95\textwidth}
    ...
    \end{flushleft} 
     ...
     \small{\textcolor[HTML]{818181}{FDI, PUBLIC CAPITAL MARKET AND VENTURE CAPITAL}}
      ...
      %\centering
        \resizebox{\textwidth}{!}{
        <<table_time_Finance,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='right',results="asis">>=  
        @      
        }
      %\vspace*{-0.2cm}
      \\[4pt]
      ...
      \begin{minipage}[c]{0.13\textwidth}
        \vspace*{+0.5cm}
        <<sparklines_Finance,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=3,fig.width=4,results="asis">>=  
        @
        \vspace*{-0.5cm}
      \end{minipage}
  \end{minipage}
 ...
 % {\color{blue!50!white}\noindent\makebox[\linewidth]{\rule{18cm}{0.3pt}}} % horiz line
  ...
  \begin{minipage}[b]{0.95\textwidth}
    ...
    \begin{minipage}[c]{0.50\textwidth} % 
      \small{\textcolor[HTML]{818181}{WEB TECHNOLOGIES \& INTERNET}}
      \\[8pt]
    %\vspace*{0.5cm}
      %\centering
        \resizebox{\textwidth}{!}{
      ...
      \begin{minipage}[c]{0.99\textwidth} % 
        <<bar_chart_Markets,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2.5,fig.width=6.5,results="asis">>=  
        @            
      \vspace{-5ex}
      \end{minipage}
%'       \begin{minipage}[c]{0.49\textwidth} % 
...
\end{minipage}
  ...
  \begin{minipage}[c]{0.65\textwidth}
    \vspace*{-0.1cm}
    \raggedleft{\color{white!40!black} \footnotesize ENTREPRENEURSHIP INDICATORS AT A GLANCE - UPDATED \Sexpr{date}}
  \end{minipage}
\end{figure}
%%%%%%%%%%%%%%%% END OF DOCUMENT %%%%%%%%%%%%%%%%%%%
\end{document}