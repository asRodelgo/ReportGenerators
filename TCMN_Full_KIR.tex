...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2016) & Poverty rate (2006) & Ease of Doing Business Rank (2016) &  &  &  &  \\ 
    0.11 &  14.14 & 149.00 &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- &   --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 10.3 &  9.7 & 10.2 &  9.6 & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 1.11 & 0.74 & 4.98 & 0.68 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 2.67 & 1.72 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:12:01 2016
{\large
\begin{tabular}{lrrrr}
  & DB 2015 Rank & DB 2016 Rank & Change in Rank &  \\ 
  \hline
Dealing with Construction Permits & 135 & 137 & \color{red}{\Large-2} &  \\ 
  Ease of Doing Business Rank & 143 & 149 & \color{red}{\Large-6} &  \\ 
  Enforcing Contracts & 113 & 114 & \color{red}{\Large-1} &  \\ 
  Getting Credit & 160 & 162 & \color{red}{\Large-2} &  \\ 
  Getting Electricity & 170 & 173 & \color{red}{\Large-3} &  \\ 
  Paying Taxes & 14 & 23 & \color{red}{\Large-9} &  \\ 
  Protecting Minority Investors & 121 & 122 & \color{red}{\Large-1} &  \\ 
  Registering Property & 141 & 142 & \color{red}{\Large-1} &  \\ 
  Resolving Insolvency & 189 & 189 & 0 &  \\ 
  Starting a Business & 133 & 142 & \color{red}{\Large-9} &  \\ 
  Trading Across Borders & 113 & 112 & \color{green}{\Large1} &  \\ 
  \end{tabular}
}
