...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/KI.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Kiribati}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Poverty rate (2006) \large{[1]} & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  \\ 
    0.12 & 810.00 &  14.14 &     NA & 149.00 &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &   --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 10.2 & 10.2 &  9.6 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 10.3 &  8.2 &  8.4 & 16.4 & 20.9 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &    --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} &  1.08 &  4.98 &  0.68 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &  2.39 & 11.27 &    --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:07:32 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{49.99} & \textbf{49.5} & \textbf{\color{red}{-0.49}} & \textbf{143} & \textbf{149} & \textbf{\color{red}{-6}} &  \\ 
  Dealing with Construction Permits & 61.79 & 61.78 & \color{red}{-0.01} & 135 & 137 & \color{red}{-2} &  \\ 
  Enforcing Contracts & 54.31 & 54.31 & 0 & 113 & 114 & \color{red}{-1} &  \\ 
  Getting Credit & 20 & 20 & 0 & 160 & 162 & \color{red}{-2} &  \\ 
  Getting Electricity & 38.97 & 37.96 & \color{red}{-1.01} & 170 & 173 & \color{red}{-3} &  \\ 
  Paying Taxes & 91.03 & 87.51 & \color{red}{-3.52} & 14 & 23 & \color{red}{-9} &  \\ 
  Protecting Minority Investors & 45 & 45 & 0 & 121 & 122 & \color{red}{-1} &  \\ 
  Registering Property & 49.94 & 49.94 & 0 & 141 & 142 & \color{red}{-1} &  \\ 
  Resolving Insolvency & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Starting a Business & 76.75 & 76.46 & \color{red}{-0.29} & 133 & 142 & \color{red}{-9} &  \\ 
  Trading Across Borders & 62.08 & 62.08 & 0 & 113 & 112 & \color{green}{1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:07:33 2016
{\Large
\begin{tabular}{lrr}
  & 2006 &  \\ 
  \hline
Import duties collected (\%, 2010-2012) \large{[1]} & 10 &  \\ 
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Kiribati - Country assistance strategy for the period FY2011-2014 & 2011-03-01 &  \\ 
  \end{tabular}
}
