...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/MV.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Maldives}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Poverty rate (2009) \large{[1]} & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  \\ 
    0.38 & 300.00 &   5.59 &     NA & 128.00 &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &    --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &  0.22 &  0.12 &  0.11 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 47.27 & 64.06 & 66.31 & 72.88 & 82.81 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 25.5 & --- & --- & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7.5 & 12.7 & 12.2 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 26.6 & 80.0 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &  --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 2.2 & 1.7 & 2.4 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:50 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{55.05} & \textbf{55.04} & \textbf{\color{red}{-0.01}} & \textbf{125} & \textbf{128} & \textbf{\color{red}{-3}} &  \\ 
  Dealing with Construction Permits & 76.75 & 75.36 & \color{red}{-1.39} & 32 & 41 & \color{red}{-9} &  \\ 
  Enforcing Contracts & 57.66 & 57.66 & 0 & 95 & 95 & 0 &  \\ 
  Getting Credit & 35 & 35 & 0 & 118 & 126 & \color{red}{-8} &  \\ 
  Getting Electricity & 53.36 & 53.65 & \color{green}{0.29} & 142 & 141 & \color{green}{1} &  \\ 
  Paying Taxes & 64.35 & 65.31 & \color{green}{0.96} & 132 & 128 & \color{green}{4} &  \\ 
  Protecting Minority Investors & 43.33 & 43.33 & 0 & 133 & 134 & \color{red}{-1} &  \\ 
  Registering Property & 39.97 & 39.97 & 0 & 169 & 171 & \color{red}{-2} &  \\ 
  Resolving Insolvency & 33.12 & 33.02 & \color{red}{-0.1} & 134 & 135 & \color{red}{-1} &  \\ 
  Starting a Business & 91.07 & 91.26 & \color{green}{0.19} & 47 & 48 & \color{red}{-1} &  \\ 
  Trading Across Borders & 55.87 & 55.87 & 0 & 136 & 137 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:51 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2011 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 22 & 22.1 &  \\ 
  Binding (\%) & 96.7 & 96.7 &  \\ 
  Dispersion (Standard Deviation) & 12.8 & 13.7 &  \\ 
  Import duties collected (\%, 2009-2011) \large{[1]} & --- & 8.8 &  \\ 
  MFN Tariff (Agriculture) & 18.2 & 18.2 &  \\ 
  MFN Tariff (Non-Agriculture) & 20.8 & 20.8 &  \\ 
  MFN Tariff (Simple Average) & 20.3 & 20.4 &  \\ 
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Maldives - Systematic country diagnostic & 2015-12-23 &  \\ 
  Maldives - Country partnership framework for the period FY16-19 & 2016-04-26 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.5in}>{\raggedright}p{0.5in}>{\raggedright}p{0.5in}>{\raggedright}p{0.6in}>{\raggedright}p{0.5in}>{\raggedright}p{0.5in}>{\raggedleft}p{0.5in}>{\raggedleft}p{0.5in}l}
 Project ID & Project Name & Team Leader & Approval Date & Lending Inst. Type & Begin Appraisal & Commitment (US\$M) & Latest Sort Overall Risk Rating & FY Expenses (US\$K) & Cum Expenses (US\$K) & FY Prob &  \\ 
  \hline
P157447 & Entrepreneurship and jobs in Maldives & Emanuel Salinas Munoz & 2017-02-16 & IPF & 2016-11-17 & 9 & --- & 72 & 72 & D &  \\ 
  \end{tabular}
}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:05:52 2016
{\footnotesize
\scalebox{0.85}{
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.4in}>{\raggedright}p{0.4in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Concept Approval Date & Output Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P132978 & Maldives Tourism Phase III & Kirthisri Rajatha Wijeweera & --- & 2013-03-17 & TA & N & --- & 0 & 30 & 30 &  \\ 
  \end{tabular}
}
}
