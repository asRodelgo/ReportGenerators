...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Poverty rate (2010) \large{[1]} & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  \\ 
    0.2 & 960.0 &  33.9 &  12.6 & 166.0 &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &    --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &   1.8 &   8.7 &   8.0 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 197.9 &  71.3 &  68.9 &  82.5 &  91.9 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 15.1 &  3.2 &  5.2 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 61.8 & 10.0 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &  --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 5.3 & 4.2 & 3.2 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr|rrrr}
  ...
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{45.22} & \textbf{45.5} & \textbf{\color{green}{0.28}} & \textbf{163} & \textbf{166} & \textbf{\color{red}{-3}} &  \\ 
  Dealing with Construction Permits & 64.12 & 64.26 & \color{green}{0.14} & 120 & 121 & \color{red}{-1} &  \\ 
  Enforcing Contracts & 29.36 & 29.36 & 0 & 182 & 182 & 0 &  \\ 
  Getting Credit & 0 & 0 & 0 & 185 & 185 & 0 &  \\ 
  Getting Electricity & 60.18 & 60.32 & \color{green}{0.14} & 111 & 115 & \color{red}{-4} &  \\ 
  Paying Taxes & 51.65 & 51.65 & 0 & 162 & 164 & \color{red}{-2} &  \\ 
  Protecting Minority Investors & 25 & 25 & 0 & 185 & 185 & 0 &  \\ 
  Registering Property & 44.03 & 44.03 & 0 & 158 & 162 & \color{red}{-4} &  \\ 
  Resolving Insolvency & 21.7 & 23.73 & \color{green}{2.03} & 161 & 158 & \color{green}{3} &  \\ 
  Starting a Business & 93.74 & 93.85 & \color{green}{0.11} & 22 & 31 & \color{red}{-9} &  \\ 
  Trading Across Borders & 62.43 & 62.78 & \color{green}{0.35} & 112 & 111 & \color{green}{1} &  \\ 
  \end{tabular}
}
