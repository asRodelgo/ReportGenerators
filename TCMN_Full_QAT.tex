...
GDP growth (annual \%) & --- & --- & --- &   --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 0.34 & 0.42 & 0.28 & 0.24 & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- &    --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 36.96 & 28.07 & 28.57 & 32.38 & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  4.28 &  0.21 & -0.42 &  0.50 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 11.98 &  0.60 &    NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- & --- &  --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 3.2 & 5.4 & 6.6 & 6.4 & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:08:01 2016
{\large
\begin{tabular}{lrrrr}
  & DB 2015 Rank & DB 2016 Rank & Change in Rank &  \\ 
  \hline
Dealing with Construction Permits & 8 & 8 & 0 &  \\ 
  Ease of Doing Business Rank & 65 & 68 & \color{red}{\Large-3} &  \\ 
  Enforcing Contracts & 111 & 112 & \color{red}{\Large-1} &  \\ 
  Getting Credit & 128 & 133 & \color{red}{\Large-5} &  \\ 
  Getting Electricity & 105 & 111 & \color{red}{\Large-6} &  \\ 
  Paying Taxes & 1 & 1 & 0 &  \\ 
  Protecting Minority Investors & 121 & 122 & \color{red}{\Large-1} &  \\ 
  Registering Property & 27 & 28 & \color{red}{\Large-1} &  \\ 
  Resolving Insolvency & 48 & 51 & \color{red}{\Large-3} &  \\ 
  Starting a Business & 103 & 109 & \color{red}{\Large-6} &  \\ 
  Trading Across Borders & 122 & 119 & \color{green}{\Large3} &  \\ 
  \end{tabular}
}
...
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 4.8 & 3.9 &  \\ 
  Binding (\%) & 100 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 5.4 & 11.8 &  \\ 
  Import duties collected (\%, 2008-2010) \large{[1]} & --- & 3.3 &  \\ 
  MFN Tariff (Agriculture) & 6.5 & 5.5 &  \\ 
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Management Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P158624 & QA SMEs' Access to Public Contracts & Aminur Rahman & 2017-04-30 & TA & Y & --- & 0 & --- & 0 &  \\ 
  P159021 & QA Economic Diversification PS Growth & Andrei Mikhnev & 2016-12-31 & TA & Y &  0 & 0 &  0 & 0 &  \\ 
  \end{tabular}
}
}
