...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/SM.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}San Marino}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  General government gross debt \large{[3]} & 15 & 21 & 19 & 19 & 22 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &  --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & NaN &  NA &  --- & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & NaN &  NA &  --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:08:45 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{63.64} & \textbf{64.21} & \textbf{\color{green}{0.57}} & \textbf{78} & \textbf{76} & \textbf{\color{green}{2}} &  \\ 
  Dealing with Construction Permits & 72.42 & 72.37 & \color{red}{-0.05} & 61 & 64 & \color{red}{-3} &  \\ 
  Enforcing Contracts & 59.25 & 59.25 & 0 & 82 & 82 & 0 &  \\ 
  Getting Credit & 5 & 5 & 0 & 180 & 181 & \color{red}{-1} &  \\ 
  Getting Electricity & 90.63 & 90.63 & 0 & 9 & 10 & \color{red}{-1} &  \\ 
  Paying Taxes & 84.35 & 84.14 & \color{red}{-0.21} & 30 & 32 & \color{red}{-2} &  \\ 
  Protecting Minority Investors & 45 & 45 & 0 & 121 & 122 & \color{red}{-1} &  \\ 
  Registering Property & 65.66 & 65.65 & \color{red}{-0.01} & 78 & 80 & \color{red}{-2} &  \\ 
  Resolving Insolvency & 39.11 & 39.15 & \color{green}{0.04} & 107 & 106 & \color{green}{1} &  \\ 
  Starting a Business & 76.81 & 82.69 & \color{green}{5.88} & 132 & 113 & \color{green}{19} &  \\ 
  Trading Across Borders & 98.22 & 98.22 & 0 & 18 & 18 & 0 &  \\ 
  \end{tabular}
}
