...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/BN.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Brunei Darussalam}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &   --- & --- &  \\ 
  ...
  General government gross debt \large{[3]} & 0.79 & 2.21 & 2.31 & 3.09 & 3.91 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 13.7 & 15.3 & 27.3 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  8.9 &  4.8 &  3.8 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 58.9 & 31.4 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &  --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 3.0 & 4.8 & 6.4 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:10:49 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{58.02} & \textbf{62.93} & \textbf{\color{green}{4.91}} & \textbf{105} & \textbf{84} & \textbf{\color{green}{21}} &  \\ 
  Dealing with Construction Permits & 79.08 & 79.07 & \color{red}{-0.01} & 21 & 21 & 0 &  \\ 
  Enforcing Contracts & 54.47 & 54.47 & 0 & 112 & 113 & \color{red}{-1} &  \\ 
  Getting Credit & 45 & 50 & \color{green}{5} & 90 & 79 & \color{green}{11} &  \\ 
  Getting Electricity & 74.92 & 74.91 & \color{red}{-0.01} & 64 & 68 & \color{red}{-4} &  \\ 
  Paying Taxes & 84.4 & 89.61 & \color{green}{5.21} & 29 & 16 & \color{green}{13} &  \\ 
  Protecting Minority Investors & 43.33 & 43.33 & 0 & 133 & 134 & \color{red}{-1} &  \\ 
  Registering Property & 48.57 & 48.57 & 0 & 148 & 148 & 0 &  \\ 
  Resolving Insolvency & 41.05 & 41.05 & 0 & 99 & 98 & \color{green}{1} &  \\ 
  Starting a Business & 48.69 & 87.63 & \color{green}{38.94} & 181 & 74 & \color{green}{107} &  \\ 
  Trading Across Borders & 60.65 & 60.65 & 0 & 120 & 121 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:10:50 2016
{\Large
\begin{tabular}{lrr}
  & 2014 &  \\ 
  \hline
Import duties collected \large{[1]} & --- &  \\ 
  Services sectors with GATS commitments \large{[1]} & 22 &  \\ 
  \end{tabular}
}
