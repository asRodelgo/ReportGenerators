...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 0.76 & 0.65 & 0.70 & 0.54 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 3.65 & 3.46 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrr}
  ...
  \hline
Dealing with Construction Permits & 5 & 6 & \color{red}{\Large-1} &  \\ 
  Ease of Doing Business Rank & 11 & 11 & 0 &  \\ 
  Enforcing Contracts & 15 & 16 & \color{red}{\Large-1} &  \\ 
  Getting Credit & 52 & 59 & \color{red}{\Large-7} &  \\ 
  Getting Electricity & 2 & 2 & 0 &  \\ 
  Paying Taxes & 39 & 39 & 0 &  \\ 
  Protecting Minority Investors & 24 & 25 & \color{red}{\Large-1} &  \\ 
  Registering Property & 18 & 18 & 0 &  \\ 
  Resolving Insolvency & 19 & 21 & \color{red}{\Large-2} &  \\ 
  Starting a Business & 14 & 22 & \color{red}{\Large-8} &  \\ 
  Trading Across Borders & 65 & 65 & 0 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr}
  & 2010 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 5.5 & 5.3 &  \\ 
  Binding (\%) & 100 & 100 &  \\ 
  Dispersion (Standard Deviation) & 18.6 & 15.8 &  \\ 
  Import duties collected \large{[1]} & --- & --- &  \\ 
  MFN Tariff (Agriculture) & 16.9 & 16.7 &  \\ 
  MFN Tariff (Non-Agriculture) & 4.1 & 4.1 &  \\ 
  MFN Tariff (Simple Average) & 6.2 & 5.9 &  \\ 
  Services sectors with GATS commitments \large{[1]} & --- & 119 &  \\ 
  \end{tabular}
}
