...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/TW.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Taiwan, China}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (2016) & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  &  &  \\ 
  23.6 &  3.8 & 11.0 &  &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  General government gross debt \large{[3]} & 34 & 39 & 39 & 38 & 38 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 0.75 & 0.70 & 0.54 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 3.20 & 3.18 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr|rrrr}
  ...
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{80.53} & \textbf{80.55} & \textbf{\color{green}{0.02}} & \textbf{11} & \textbf{11} & \textbf{0} &  \\ 
  Dealing with Construction Permits & 86.27 & 86.29 & \color{green}{0.02} & 5 & 6 & \color{red}{-1} &  \\ 
  Enforcing Contracts & 73.49 & 73.49 & 0 & 15 & 16 & \color{red}{-1} &  \\ 
  Getting Credit & 60 & 60 & 0 & 52 & 59 & \color{red}{-7} &  \\ 
  Getting Electricity & 99.21 & 99.43 & \color{green}{0.22} & 2 & 2 & 0 &  \\ 
  Paying Taxes & 82.9 & 82.78 & \color{red}{-0.12} & 39 & 39 & 0 &  \\ 
  Protecting Minority Investors & 66.67 & 66.67 & 0 & 24 & 25 & \color{red}{-1} &  \\ 
  Registering Property & 83.89 & 83.89 & 0 & 18 & 18 & 0 &  \\ 
  Resolving Insolvency & 78.41 & 78.41 & 0 & 19 & 21 & \color{red}{-2} &  \\ 
  Starting a Business & 94.39 & 94.41 & \color{green}{0.02} & 14 & 22 & \color{red}{-8} &  \\ 
  Trading Across Borders & 80.11 & 80.11 & 0 & 65 & 65 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:09:23 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 5.5 & 5.1 &  \\ 
  Binding (\%) & 100.0 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 18.6 & 10.1 &  \\ 
  MFN Tariff (Agriculture) & 16.9 & 13.1 &  \\ 
  MFN Tariff (Non-Agriculture) & 4.1 & 4.1 &  \\ 
  MFN Tariff (Simple Average) & 6.2 & 5.4 &  \\ 
  \end{tabular}
}
