...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/PF.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}French Polynesia}
    \end{minipage}
  \end{minipage}
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} & 0.83 & 1.58 & 1.97 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 3.52 & 6.69 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr}
  & 2011 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 6.7 & 7.5 &  \\ 
  Dispersion (Standard Deviation) & 4.4 & 4.0 &  \\ 
  MFN Tariff (Agriculture) & 6.7 & 5.7 &  \\ 
  MFN Tariff (Non-Agriculture) & 11.4 & 9.7 &  \\ 
  MFN Tariff (Simple Average) & 10.8 & 9.2 &  \\ 
  \end{tabular}
}
