...
Gross domestic investment (\% GDP) & --- & --- & --- &    --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} &   3.0 & -12.6 &   8.7 &   9.1 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &  11.4 & -49.2 &    NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &  --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 1.6 & 3.1 & 3.3 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 08:59:48 2016
{\Large
\begin{tabular}{lrrr}
  & 2011 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 10.2 & --- &  \\ 
  Dispersion (Standard Deviation) & 7.4 & --- &  \\ 
  Import duties collected \large{[1]} & --- & --- &  \\ 
  MFN Tariff (Agriculture) & 6.2 & --- &  \\ 
  MFN Tariff (Non-Agriculture) & 10.3 & --- &  \\ 
  MFN Tariff (Simple Average) & 9.6 & --- &  \\ 
