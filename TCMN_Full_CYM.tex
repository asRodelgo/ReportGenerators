...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/KY.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Cayman Islands}
    \end{minipage}
  \end{minipage}
...
Gross domestic investment (\% GDP) & --- & --- &    --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} &   346 &   364 &   520 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 1,545 & 1,622 &    --- & --- & --- & --- &  \\ 
  \end{tabular}
}
