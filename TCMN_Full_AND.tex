...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `\$<-.data.frame`(`*tmp*`, "{}IndicatorShort"{}, value = "{} ()"{}): replacement has 1 row, data has 0}}\end{kframe}
    }
  \end{minipage}  
