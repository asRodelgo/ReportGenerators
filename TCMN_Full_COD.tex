...
GDP growth (annual \%) & --- & --- & --- &    --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 0.137 & 0.044 & 0.110 & 0.068 & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 13.4 & 20.0 & 21.6 & 20.7 & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  5.9 & 11.3 &  6.4 &  5.8 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 49.9 & 62.4 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- & --- &   --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 0.77 & 1.62 & 1.23 & 1.03 & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:11:18 2016
{\large
\begin{tabular}{lrrrr}
  & DB 2015 Rank & DB 2016 Rank & Change in Rank &  \\ 
  \hline
Dealing with Construction Permits & 157 & 131 & \color{green}{\Large26} &  \\ 
  Ease of Doing Business Rank & 187 & 184 & \color{green}{\Large3} &  \\ 
  Enforcing Contracts & 165 & 165 & 0 &  \\ 
  Getting Credit & 128 & 133 & \color{red}{\Large-5} &  \\ 
  Getting Electricity & 173 & 174 & \color{red}{\Large-1} &  \\ 
  Paying Taxes & 170 & 173 & \color{red}{\Large-3} &  \\ 
  Protecting Minority Investors & 173 & 174 & \color{red}{\Large-1} &  \\ 
  Registering Property & 135 & 135 & 0 &  \\ 
  Resolving Insolvency & 189 & 189 & 0 &  \\ 
  Starting a Business & 172 & 89 & \color{green}{\Large83} &  \\ 
  Trading Across Borders & 187 & 187 & 0 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrl}
  ...
  \hline
Number of electrical outages in a typical month & 8.30 & 12.30 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 23.10 & 9.40 & 34.30 &  \\ 
  Proportion of investment financed by banks (\%) & 9.90 & 0.90 & 14.30 &  \\ 
  Proportion of investment financed internally (\%) & 76.70 & 92.20 & 71.80 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 8.20 & 4.70 & 9.90 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600085 & Improving DRC's Investment Climate at National and Provincial Levels & Traore, Alain Tienmfoltien & 2015-09-29 & 2017-06-30 & 475 & 280 & 146 &  \\ 
  \end{tabular}
}
}
