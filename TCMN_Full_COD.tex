...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/CD.png}
    \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (2016) \large{[1]} & Land area (sq. km) (2015) & Poverty rate (2012) & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  &  \\ 
         84 & 2,267,050 &        77 &        NA &       184 &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- &    --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &  0.13 &  0.11 &  0.07 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} & 86.36 & 19.12 & 16.80 & 18.81 & 19.76 & --- &  \\ 
...
{\centering \includegraphics[width=\maxwidth]{figure/createSparklines_macro-1} 
    ...
    \begin{minipage}[c]{0.875\textwidth}
      ...
      \resizebox{\textwidth}{!}{
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:54:06 2016
{\Large
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 14.1 & 21.6 & 20.7 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  6.4 &  6.4 &  5.8 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 43.0 & 31.2 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 0.88 & 1.23 & 1.03 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr|rrrr}
  ...
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{34.79} & \textbf{38.14} & \textbf{\color{green}{3.35}} & \textbf{187} & \textbf{184} & \textbf{\color{green}{3}} &  \\ 
  Dealing with Construction Permits & 55.72 & 62.43 & \color{green}{6.71} & 157 & 131 & \color{green}{26} &  \\ 
  Enforcing Contracts & 37.91 & 37.91 & 0 & 165 & 165 & 0 &  \\ 
  Getting Credit & 30 & 30 & 0 & 128 & 133 & \color{red}{-5} &  \\ 
  Getting Electricity & 35.52 & 36.49 & \color{green}{0.97} & 173 & 174 & \color{red}{-1} &  \\ 
  Paying Taxes & 44.88 & 43.5 & \color{red}{-1.38} & 170 & 173 & \color{red}{-3} &  \\ 
  Protecting Minority Investors & 33.33 & 33.33 & 0 & 173 & 174 & \color{red}{-1} &  \\ 
  Registering Property & 50.71 & 50.77 & \color{green}{0.06} & 135 & 135 & 0 &  \\ 
  Resolving Insolvency & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Starting a Business & 58.53 & 85.69 & \color{green}{27.16} & 172 & 89 & \color{green}{83} &  \\ 
  Trading Across Borders & 1.26 & 1.26 & 0 & 187 & 187 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:54:07 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 11.9 & 11.6 &  \\ 
  Binding (\%) & 100 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 6.2 & 6.2 &  \\ 
  Import duties collected (\%, 2008-2010) \large{[1]} & --- & 6.8 &  \\ 
  MFN Tariff (Agriculture) & 11 & 11.0 &  \\ 
  MFN Tariff (Non-Agriculture) & 10.9 & 10.9 &  \\ 
  MFN Tariff (Simple Average) & 10.9 & 10.9 &  \\ 
...
{\Large
\begin{tabular}{lrrrl}
  & Sub-Saharan Africa & Congo, Dem. Rep. & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 8.50 & 12.30 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 22.70 & 9.40 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 9.70 & 0.90 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 75.80 & 92.20 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 7.60 & 4.70 & 10.00 &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:54:08 2016
\scalebox{0.85}{
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Congo, Democratic Republic of - Performance and learning review of the country assistance strategy for the period FY13-16 & 2016-05-17 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600085 & Improving DRC's Investment Climate at National and Provincial Levels & Traore, Alain Tienmfoltien & 2015-09-29 & 2017-06-30 & 875 & 381 & 247 &  \\ 
  \end{tabular}
}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 10:54:09 2016
{\scriptsize
\scalebox{0.85}{
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
562251 & Developing a Framework for Special Economic Zones in DRC & Scheuermaier, Markus & 2008-04-10 & 2012-12-31 & 3,322 & 2,586 & 0 &  \\ 
  559845 & Investment Promotion, Taxes and Doing Business & Scheuermaier, Markus & 2007-10-01 & 2009-06-30 &   265 &   278 & 0 &  \\ 
  538707 & Administrative Barriers Study & Stern, Richard & 2005-08-22 & --- &     0 &     0 & 0 &  \\ 
  \end{tabular}
}
}
