...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/TO.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Tonga}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &  --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &  26 &  28 &  26 & --- & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} &  7.5 & 11.7 & 12.9 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 32.4 & 51.7 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- &  --- & --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 4.5 & 6.4 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:06:51 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{64.17} & \textbf{64.13} & \textbf{\color{red}{-0.04}} & \textbf{74} & \textbf{78} & \textbf{\color{red}{-4}} &  \\ 
  Dealing with Construction Permits & 79.05 & 79 & \color{red}{-0.05} & 22 & 22 & 0 &  \\ 
  Enforcing Contracts & 57.32 & 57.32 & 0 & 97 & 97 & 0 &  \\ 
  Getting Credit & 65 & 65 & 0 & 36 & 42 & \color{red}{-6} &  \\ 
  Getting Electricity & 76.27 & 76.26 & \color{red}{-0.01} & 60 & 61 & \color{red}{-1} &  \\ 
  Paying Taxes & 75.93 & 75.37 & \color{red}{-0.56} & 74 & 82 & \color{red}{-8} &  \\ 
  Protecting Minority Investors & 46.67 & 46.67 & 0 & 114 & 115 & \color{red}{-1} &  \\ 
  Registering Property & 45.89 & 45.89 & 0 & 152 & 154 & \color{red}{-2} &  \\ 
  Resolving Insolvency & 33.34 & 33.6 & \color{green}{0.26} & 132 & 131 & \color{green}{1} &  \\ 
  Starting a Business & 90.74 & 90.72 & \color{red}{-0.02} & 49 & 53 & \color{red}{-4} &  \\ 
  Trading Across Borders & 71.52 & 71.52 & 0 & 87 & 87 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:06:52 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 11.1 & 11.3 &  \\ 
  Binding (\%) & 100.0 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 7.2 & 6.5 &  \\ 
  MFN Tariff (Agriculture) & 11.7 & 11.0 &  \\ 
  MFN Tariff (Non-Agriculture) & 11.5 & 11.8 &  \\ 
  MFN Tariff (Simple Average) & 11.7 & 11.8 &  \\ 
  \end{tabular}
}
...
{\Large
\begin{tabular}{lrrrl}
  & Tonga & East Asia and Pacific & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 2.00 & 3.20 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 54.30 & 31.20 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 26.50 & 9.50 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 34.20 & 79.50 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 6.60 & 4.60 & 10.00 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}ll}
 Product & Document Date &  \\ 
  \hline
Tonga - Country assistance strategy for the period FY2011-2014 & 2010-10-22 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
561891 & Tonga Regulatory Simplification and Investment Policy and Promotion Program & Beasley, Amy & 2008-04-15 & 2011-04-30 & 1,435 & 1,277 & 0 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
549045 & Tonga Regulatory  Reform:  Phase II & Moody, Alan Andrew & 2006-08-04 & 2008-06-01 & 337 & 238 & 0 &  \\ 
  538789 & Administrative Barriers (Tonga) & Duggan, Sean Malcolm & 2005-09-01 & --- &   0 &   0 & 0 &  \\ 
  538755 & Regulatory Reform Implementation & Moody, Alan Andrew & 2005-08-16 & --- &   0 &   0 & 0 &  \\ 
  \end{tabular}
}
}
