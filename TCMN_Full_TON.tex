...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2016) & Poverty rate (2009) & Ease of Doing Business Rank (2016) &  &  &  &  \\ 
   0.11 &  1.09 & 78.00 &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 26 & 26 & 28 & --- & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- & --- &   --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 24.6 & 34.0 & --- & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  7.6 &  6.7 & 11.7 & 12.9 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 12.9 &  5.3 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- &  --- & --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} & 4.3 & 6.4 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:10:03 2016
{\large
\begin{tabular}{lrrrr}
  & DB 2015 Rank & DB 2016 Rank & Change in Rank &  \\ 
  \hline
Dealing with Construction Permits & 22 & 22 & 0 &  \\ 
  Ease of Doing Business Rank & 74 & 78 & \color{red}{\Large-4} &  \\ 
  Enforcing Contracts & 97 & 97 & 0 &  \\ 
  Getting Credit & 36 & 42 & \color{red}{\Large-6} &  \\ 
  Getting Electricity & 60 & 61 & \color{red}{\Large-1} &  \\ 
  Paying Taxes & 74 & 82 & \color{red}{\Large-8} &  \\ 
  Protecting Minority Investors & 114 & 115 & \color{red}{\Large-1} &  \\ 
  Registering Property & 152 & 154 & \color{red}{\Large-2} &  \\ 
  Resolving Insolvency & 132 & 131 & \color{green}{\Large1} &  \\ 
  Starting a Business & 49 & 53 & \color{red}{\Large-4} &  \\ 
  Trading Across Borders & 87 & 87 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed Feb 17 09:10:04 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2014 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 11.1 & --- &  \\ 
  Binding (\%) & 100 & --- &  \\ 
  Dispersion (Standard Deviation) & 7.2 & --- &  \\ 
  Import duties collected \large{[1]} & --- & --- &  \\ 
  MFN Tariff (Agriculture) & 11.7 & --- &  \\ 
  MFN Tariff (Non-Agriculture) & 11.5 & --- &  \\ 
  MFN Tariff (Simple Average) & 11.7 & --- &  \\ 
  Services sectors with GATS commitments \large{[1]} & --- & 90 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrl}
  ...
  \hline
Number of electrical outages in a typical month & 2.00 & 3.50 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 54.30 & 35.00 & 34.30 &  \\ 
  Proportion of investment financed by banks (\%) & 26.50 & 12.80 & 14.30 &  \\ 
  Proportion of investment financed internally (\%) & 34.20 & 74.70 & 71.80 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 6.60 & 6.70 & 9.90 &  \\ 
  \end{tabular}
}
