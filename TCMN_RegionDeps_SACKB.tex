...
\vspace{2ex}
\raggedright{\Large Country Management Unit: \color{white!30!blue} \textbf{SACKB}}
...
\raggedright{\textbf{\Large \color{white!30!blue}Afghanistan\\
 }}
