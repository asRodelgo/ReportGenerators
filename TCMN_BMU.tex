...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/BM.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Bermuda}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} & 22 & 22 & --- & --- & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &    --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 13.11 & 11.74 & --- & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  3.21 &  0.98 & -0.56 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 19.32 &  8.39 &    --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:35:06 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 18.9 & 17.2 &  \\ 
  Dispersion (Standard Deviation) & 21.9 & 9.1 &  \\ 
  Import duties collected \large{[1]} & --- & --- &  \\ 
  MFN Tariff (Agriculture) & 12.7 & 7.9 &  \\ 
  MFN Tariff (Non-Agriculture) & 19.1 & 19 &  \\ 
  MFN Tariff (Simple Average) & 17.9 & 17.4 &  \\ 
