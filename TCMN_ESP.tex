...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/ES.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Spain}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   1.65 &  -1.23 &   1.39 &   3.00 &   2.70 &   1.90 &  \\ 
  Current account balance &  -5.28 &   0.77 &   0.44 &   0.79 &   0.87 &   1.25 &  \\ 
  Fiscal balance (\% of GDP) &  -3.92 &  -7.33 &  -6.10 &  -4.86 &  -2.97 &  -2.05 &  \\ 
  Remittances, received (\% of GDP) \large{[1]} &   0.23 &   0.22 &   0.23 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  51.63 &  93.67 &  99.29 &  98.95 &  99.03 & --- &  \\ 
  Real Effective Exchange Rate (2010=100) &  99.40 & 100.37 & 100.00 &  93.85 &  93.08 &  92.55 &  \\ 
  Consumer Price Index, annual percent change &   2.84 &   1.41 &  -0.15 &  -0.89 &  -0.87 &  -0.87 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & 25.9 & 19.9 & 20.3 & 21.3 & 22.3 & 22.4 &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 26.9 & 19.1 & 19.8 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  2.9 &  3.0 &  1.6 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 10.7 & 16.2 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Total Trade in Goods and Services (\% of GDP, real terms) & 52.88 & 55.91 & 58.34 & 58.93 & 60.34 & 62.04 &  \\ 
  Trade balance (\% GDP, real terms) & -2.13 &  4.27 &  3.49 &  3.97 &  4.16 &  4.73 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &  2.82 &  4.30 &  4.16 &  4.80 &  5.30 &  5.50 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) &  1.89 & -0.43 &  7.69 &  3.21 &  4.99 &  3.94 &  \\ 
  Total reserves in months of imports \large{[1]} &  0.74 &  1.20 &  1.24 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:33:26 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{73.78} & \textbf{74.86} & \textbf{\color{green}{1.08}} & \textbf{34} & \textbf{33} & \textbf{\color{green}{1}} &  \\ 
  Dealing with Construction Permits & 67.51 & 67.56 & \color{green}{0.05} & 97 & 101 & \color{red}{-4} &  \\ 
  Enforcing Contracts & 67.63 & 67.63 & 0 & 39 & 39 & 0 &  \\ 
  Getting Credit & 60 & 60 & 0 & 52 & 59 & \color{red}{-7} &  \\ 
  Getting Electricity & 70.23 & 72.96 & \color{green}{2.73} & 78 & 74 & \color{green}{4} &  \\ 
  Paying Taxes & 74.74 & 79.48 & \color{green}{4.74} & 79 & 60 & \color{green}{19} &  \\ 
  Protecting Minority Investors & 61.67 & 65 & \color{green}{3.33} & 44 & 29 & \color{green}{15} &  \\ 
  Registering Property & 73.88 & 73.88 & 0 & 48 & 49 & \color{red}{-1} &  \\ 
  Resolving Insolvency & 75.89 & 75.83 & \color{red}{-0.06} & 23 & 25 & \color{red}{-2} &  \\ 
  Starting a Business & 86.26 & 86.3 & \color{green}{0.04} & 78 & 82 & \color{red}{-4} &  \\ 
...
Number of electrical outages in a typical month & 6.30 & --- &  \\ 
  ...
  Proportion of investments financed by banks (\%) & 14.60 & 21.8 &  \\ 
  Proportion of investments financed internally (\%) & 71.20 & 59.9 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 10.00 & 0.8 &  \\ 
  \end{tabular}
}
