...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2017) & Land area (sq. km) (2015) & Unemployment rate (2014) &  &  &  &  &  \\ 
       11.4 & 627,340.0 &       6.9 &  &  &  &  &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) & NA & --- & --- & --- & --- & --- &  \\ 
  ...
  General government gross debt \large{[3]} & NA & --- & --- & --- & --- & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  ...
  Inward FDI (\% of GDP) \large{[2]} &  4.3 &  7.7 &  7.5 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 21.6 & 38.4 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
