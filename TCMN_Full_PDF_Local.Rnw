...
\newpage
%%%%%%%%%%%%%%%% PAGE 3 %%%%%%%%%%%%%%%%%%%
<<setup2,echo=FALSE,message=FALSE,cache=FALSE>>= 
#library(knitr)
# Global chunk options: Cache chunks which source R code
...
%'       \vspace*{0.3cm}
%'      <<projectStatus_count,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',out.width='.60\\textwidth',results="asis">>=  
%'       @      
%'     \end{minipage}
%'     \begin{minipage}[c]{0.49\textwidth}
%'       \center{\color{blue!50!black} \textbf{\small By amount in thousands of US\$ \\ (ASA IBRD products not included)}}
%'       <<projectStatus_amount,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',out.width='.60\\textwidth',results="asis">>=  
%'       @
%'     \end{minipage}
%'  
%' %\hspace*{0.5cm} 
...
%'     \center{\color{blue!50!black} \textbf{Active}}
%'     \vspace*{0.4cm}
%'       <<projectsTreemap_sectors,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',out.width='.80\\textwidth',results="asis">>=  
%'     @      
...
%'     \vspace*{0.4cm}
%'     <<projectsTreemap_themes,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',out.width='.80\\textwidth',results="asis">>=  
%'     @            
%'   %\hspace*{0.5cm} 
