...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/IS.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Iceland}
    \end{minipage}
  \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  GDP (US\$ billions) (2017) & Population (millions) (2017) & Land area (sq. km) (2015) & Income per capita (current US\$) (2017) & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  &  \\ 
       19.60 &       0.34 & 100,250.00 &  57,977.69 &       3.80 &      19.00 &  &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   2.65 &   3.56 &   1.87 &   2.90 &   2.80 &   2.50 &  \\ 
  Current account balance &  -9.25 &   5.95 &   4.37 &   1.67 &   1.50 &   1.64 &  \\ 
  Fiscal balance (\% of GDP) &  -2.61 &  -2.06 &   0.68 &  -0.75 &  -0.49 &   1.11 &  \\ 
  Remittances, received (\% of GDP) \large{[1]} &   0.76 &   1.23 &   1.21 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  56.25 &  84.81 &  82.51 &  67.59 &  56.10 & --- &  \\ 
  Real Effective Exchange Rate (2010=100) & 130.39 & 106.19 & 113.66 & 132.73 & 134.05 & 135.36 &  \\ 
  Consumer Price Index, annual percent change &   5.98 &   3.87 &   2.05 &   1.05 &   1.20 &   1.26 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/createSparklines_macro-1} 
    ...
    \begin{minipage}[c]{0.875\textwidth}
      ...
      \resizebox{\textwidth}{!}{
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:36:37 2016
{\Large
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Gross domestic investment (\% GDP) & 21.1 & 12.7 & 14.2 & 16.8 & 17.7 & 18.4 &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 22.7 & 15.0 & 16.8 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &  9.5 &  2.6 &  2.6 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 37.1 & 16.7 &   NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  & Avg 2003-2012 & 2013 & 2014 & 2015 & 2016 & 2017 &  \\ 
  \hline
Total Trade in Goods and Services (\% of GDP, real terms) & 66.12 & 69.28 & 71.99 & 75.96 & 79.55 & 83.18 &  \\ 
  Trade balance (\% GDP, real terms) & -0.92 & 12.01 & 10.29 &  8.92 &  9.29 &  9.87 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &  5.40 &  7.06 &  3.12 &  6.15 &  7.59 &  7.36 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) &  1.73 &  0.09 &  9.74 & 11.81 &  7.76 &  6.94 &  \\ 
  Total reserves in months of imports \large{[1]} &  6.15 &  5.91 &  5.38 & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:36:38 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{78.89} & \textbf{78.93} & \textbf{\color{green}{0.04}} & \textbf{18} & \textbf{19} & \textbf{\color{red}{-1}} &  \\ 
  Dealing with Construction Permits & 74.9 & 74.95 & \color{green}{0.05} & 42 & 45 & \color{red}{-3} &  \\ 
  Enforcing Contracts & 69.1 & 69.1 & 0 & 34 & 35 & \color{red}{-1} &  \\ 
  Getting Credit & 60 & 60 & 0 & 52 & 59 & \color{red}{-7} &  \\ 
  Getting Electricity & 92.23 & 92.24 & \color{green}{0.01} & 8 & 8 & 0 &  \\ 
  Paying Taxes & 83.64 & 83.67 & \color{green}{0.03} & 35 & 36 & \color{red}{-1} &  \\ 
  Protecting Minority Investors & 68.33 & 68.33 & 0 & 20 & 20 & 0 &  \\ 
  Registering Property & 86.61 & 86.61 & 0 & 15 & 15 & 0 &  \\ 
  Resolving Insolvency & 81.47 & 81.65 & \color{green}{0.18} & 14 & 15 & \color{red}{-1} &  \\ 
  Starting a Business & 92.35 & 92.44 & \color{green}{0.09} & 31 & 40 & \color{red}{-9} &  \\ 
  Trading Across Borders & 80.27 & 80.27 & 0 & 64 & 64 & 0 &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/WGIindicators-1} 
  ...
  %\vspace*{0.2cm}
    ...
    \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Wed May 25 16:36:39 2016
{\Large
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 2.5 & 1.3 &  \\ 
  Binding (\%) & 95.0 & 94.9 &  \\ 
  Dispersion (Standard Deviation) & 39.4 & 7.3 &  \\ 
  MFN Tariff (Agriculture) & 30.3 & 6.5 &  \\ 
  MFN Tariff (Non-Agriculture) & 2.4 & 2.3 &  \\ 
  MFN Tariff (Simple Average) & 6.0 & 2.8 &  \\ 
  \end{tabular}
}
