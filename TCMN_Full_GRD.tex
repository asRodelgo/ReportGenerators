...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{/Users/asanchez3/shinyTCMN/www/GD.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      \section*{\color{blue!40!black}Grenada}
    \end{minipage}
  \end{minipage}
...
GDP growth (annual \%) & --- & --- & --- & --- &    --- & --- &  \\ 
  ...
  Remittances, received (\% of GDP) \large{[1]} &   5.0 &   3.5 &   3.4 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  90.8 & 106.8 & 100.8 &  92.7 &  88.3 & --- &  \\ 
...
Gross domestic investment (\% GDP) & --- & --- &   --- & --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 30.0 & 20.0 & 16.9 & --- & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} & 12.1 & 13.7 &  4.7 & --- & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} & 40.4 & 73.7 &   --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
Total Trade in Goods and Services (\% of GDP, real terms) & --- & --- & --- & --- & --- & --- &  \\ 
  ...
  Total reserves in months of imports \large{[1]} &  3 &  4 & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
    ...
    \centering
      \resizebox{\textwidth}{!}{%
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Tue May 31 11:06:13 2016
{\large
\begin{tabular}{lrrr|rrrr}
  &  & DTF &  &  & Rank &  &  \\ 
  &  2015 &  2016 &  Change & 2015 & 2016 & Change &  \\ 
   \hline
\textbf{Ease of Doing Business} & \textbf{53.44} & \textbf{53.46} & \textbf{\color{green}{0.02}} & \textbf{130} & \textbf{135} & \textbf{\color{red}{-5}} &  \\ 
  Dealing with Construction Permits & 67.58 & 67.61 & \color{green}{0.03} & 95 & 100 & \color{red}{-5} &  \\ 
  Enforcing Contracts & 58.41 & 58.41 & 0 & 89 & 89 & 0 &  \\ 
  Getting Credit & 30 & 30 & 0 & 128 & 133 & \color{red}{-5} &  \\ 
  Getting Electricity & 76.34 & 76.39 & \color{green}{0.05} & 59 & 58 & \color{green}{1} &  \\ 
  Paying Taxes & 64.46 & 64.46 & 0 & 131 & 132 & \color{red}{-1} &  \\ 
  Protecting Minority Investors & 45 & 45 & 0 & 121 & 122 & \color{red}{-1} &  \\ 
  Registering Property & 50.17 & 50.16 & \color{red}{-0.01} & 139 & 139 & 0 &  \\ 
  Resolving Insolvency & 0 & 0 & 0 & 189 & 189 & 0 &  \\ 
  Starting a Business & 86.7 & 86.84 & \color{green}{0.14} & 74 & 76 & \color{red}{-2} &  \\ 
  Trading Across Borders & 55.76 & 55.76 & 0 & 137 & 138 & \color{red}{-1} &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrr}
  & 2010 & 2015 &  \\ 
  \hline
Applied Tariff (Incl. Prefers. and Trade-Weighted) & 9.1 & 11.0 &  \\ 
  Binding (\%) & 100.0 & 100.0 &  \\ 
  Dispersion (Standard Deviation) & 10.5 & 10.0 &  \\ 
  MFN Tariff (Agriculture) & 18.2 & 18.1 &  \\ 
  MFN Tariff (Non-Agriculture) & 8.7 & 8.6 &  \\ 
  MFN Tariff (Simple Average) & 10.4 & 10.1 &  \\ 
  \end{tabular}
}
...
{\Large
\begin{tabular}{lrrrl}
  & Latin America and Caribbean & Grenada & All Countries &  \\ 
  \hline
Number of electrical outages in a typical month & 2.80 & 0.70 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 45.20 & 49.00 & 35.20 &  \\ 
  Proportion of investments financed by banks (\%) & 19.30 & 27.60 & 14.60 &  \\ 
  Proportion of investments financed internally (\%) & 63.20 & 60.40 & 71.20 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 14.00 & 7.70 & 10.00 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
538775 & Diagnostic of the Investment Environment in Grenada & Sun, Xiaolun & 2005-08-30 & --- & 0 & 0 & 0 &  \\ 
  \end{tabular}
}
}
