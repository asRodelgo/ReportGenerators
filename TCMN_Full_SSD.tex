...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  Population (millions) (2016) & Ease of Doing Business Rank (2016) &  &  &  &  &  \\ 
   13 & 187 &  &  &  &  &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{6in}r>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) & NA & --- & --- & --- & --- & --- &  \\ 
  Current account balance & NA & --- & --- & --- & --- & --- &  \\ 
  Fiscal balance (\% of GDP) & NA & --- & --- & --- & --- & --- &  \\ 
  Remittances, received (\% of GDP) \large{[1]} & NA & --- & --- & --- & --- & --- &  \\ 
  Real Effective Exchange Rate (2010=100) & NA & --- & --- & --- & --- & --- &  \\ 
  Consumer Price Index, annual percent change & NA & --- & --- & --- & --- & --- &  \\ 
  \end{tabular}
}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(x, , i): undefined columns selected}}\end{kframe}
      \vspace*{-0.5cm}
    \end{minipage}
...
Gross domestic investment (\% GDP) & --- & --- & --- &    --- & --- & --- &  \\ 
  Gross domestic investment, of w: Private investment (\% GDP) \large{[1]} & 11.50 & 11.18 & 10.60 & 10.36 & --- & --- &  \\ 
  Inward FDI (\% of GDP) \large{[2]} &   NaN &  0.00 & -0.66 & -7.29 & --- & --- &  \\ 
  Inward FDI, \% of private investment \large{[2]} &   NaN &    NA &    NA & --- & --- & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrr}
  ...
  \hline
Dealing with Construction Permits & 171 & 177 & \color{red}{\Large-6} &  \\ 
  Ease of Doing Business Rank & 186 & 187 & \color{red}{\Large-1} &  \\ 
  Enforcing Contracts & 76 & 76 & 0 &  \\ 
  Getting Credit & 171 & 174 & \color{red}{\Large-3} &  \\ 
  Getting Electricity & 183 & 187 & \color{red}{\Large-4} &  \\ 
  Paying Taxes & 104 & 104 & 0 &  \\ 
  Protecting Minority Investors & 181 & 181 & 0 &  \\ 
  Registering Property & 179 & 180 & \color{red}{\Large-1} &  \\ 
  Resolving Insolvency & 189 & 189 & 0 &  \\ 
  Starting a Business & 178 & 181 & \color{red}{\Large-3} &  \\ 
  Trading Across Borders & 179 & 179 & 0 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lrrrl}
  ...
  \hline
Number of electrical outages in a typical month & 8.30 & 1.50 & 6.30 &  \\ 
  Percent of firms with a bank loan/line of credit & 23.10 & 6.90 & 34.30 &  \\ 
  Proportion of investment financed by banks (\%) & 9.90 & 2.40 & 14.30 &  \\ 
  Proportion of investment financed internally (\%) & 76.70 & 86.20 & 71.80 &  \\ 
  Senior management time spent dealing with the requirements of government regulation (\%) & 8.20 & 18.00 & 9.90 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{5in}lll}
 Product & Concept Review Date & Board Date &  \\ 
  \hline
SS Country Engagement Note & 2016-01-25 & 2016-04-28 &  \\ 
  South Sudan SCD & 2015-03-19 & 2015-10-14 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedright}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}>{\raggedleft}p{0.6in}l}
 Task ID & Task Name & Team Leader & Management Approval Date & Product Line & RAS (Y/N) & Current Expenditure BB (US\$K) & Current Expenditure Total (US\$K) & Lifetime Expenditure BB (US\$K) & Lifetime Expenditure Total (US\$K) &  \\ 
  \hline
P147027 & SS - Investment Climate Assessment & Jean Lubega-Kyazze & 2016-02-08 & EW & N & 50 & 50 & 134 & 134 &  \\ 
  P132930 & Fostering Competitiveness and Growth & Gary J. Fine & 2015-03-30 & EW & N &  0 &  0 & 187 & 187 &  \\ 
  P132934 & The Private Sector and Job Creation & Andres F. Garcia & 2014-12-07 & EW & N & --- &  0 & 214 & 214 &  \\ 
  \end{tabular}
}
}
...
\begin{tabular}{l>{\raggedright}p{1.6in}>{\raggedright}p{1.5in}>{\raggedright}p{0.7in}>{\raggedright}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}>{\raggedleft}p{0.7in}l}
 Project ID & Project Name & Team Leader & IP Approval Date & Expected End Date & Approval Value (in US\$K) & Total Expenditures (in US\$K) & Current FY Expenditure (in US\$K) &  \\ 
  \hline
600617 & South Sudan Phase 3 (Client Engagement) & Lubega-Kyazze, Jean & 2015-03-27 & 2017-12-31 & 845 & 495 & 218 &  \\ 
  \end{tabular}
}
}
